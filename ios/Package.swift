...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            ...
            dependencies: ["Crew"],
            path: "CrewTests",
            sources: ["VectorFiles.swift", "VectorRunnerTests.swift", "VectorRunnerCrewTests.swift", "VectorRunnerNutritionTests.swift", "MacroDayTests.swift", "NutritionTargetsTests.swift", "AchievementsTests.swift", "PlanGeneratorTests.swift", "SwapFinderTests.swift", "LapsedUserTests.swift", "SpecConstantsTests.swift", "DayKeyTests.swift", "PlanRotationTests.swift", "TrainingDaysTests.swift", "DayLabelTests.swift", "SessionSummaryLineTests.swift", "WeightUnitsTests.swift", "SetPrefillTests.swift", "HomeLinesTests.swift", "WeekSummaryTests.swift"]
        ),
    ]
)
