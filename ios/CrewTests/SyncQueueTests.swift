...
final class SyncQueueTests: XCTestCase {
    ...
    private func signIn() {
        let user = UserDTO(id: "u1", email: "u@example.com", authProvider: "email", displayName: "U", profilePhotoKey: nil, units: "lb", weightUnit: "lb", distanceUnit: "mi", timezone: "UTC", reminderTime: nil, notificationPrefs: nil, welcomeBackAckDay: nil, nutrition: nil, createdAt: Date())
