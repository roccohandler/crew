...
final class HomeModelEdgeTests: XCTestCase {
    ...
    func testWelcomeBackAfterFourteenQuietDaysAndSilentOnceAnswered() throws {
        ...
        store.context.insert(LocalPost(clientId: "old", userId: userId, type: "cardio", sessionClientId: nil, caption: "", shareToCrew: false, dayKey: "2026-08-20", isPlannedDay: false, workoutCompleted: false, createdAt: friday.addingTimeInterval(-15 * TimeInterval(TimeUnits.secondsPerDay))))
        try store.save()
