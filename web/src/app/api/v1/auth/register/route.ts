...
export async function POST(req: Request) {
  try {
    ...
    const user = await createUserWithState({ email: body.email, authProvider: "email", passwordHash, displayName: body.displayName, timezone: body.timezone, measurementSystem: body.measurementSystem, birthYear: body.birthYear });
