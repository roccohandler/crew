// SPEC: 6.1 Empty — an invitation, never an apology; exactly one CTA. Mirrors ios Shared/EmptyState.
import Link from "next/link";

export function EmptyState({ title, line, ctaTitle, href, onClick }: { title: string; line: string; ctaTitle: string; href?: string; onClick?: () => void }) {
  return (
