...
const PAGES = ["/", "/onboarding", "/login", "/reset", "/join/warm-up", "/home", "/plan", "/crew", "/progress", "/journal", "/settings", "/session/new", "/session/warm-up", "/session/warm-up/done", "/plan/push", "/log-cardio", "/privacy", "/terms"];
const ROUTES = ["auth/register", "auth/login", "auth/logout", "auth/refresh", "auth/reset", "users/me", "plans", "sessions", "sessions/warm-up", "posts", "posts/warm-up", "posts/warm-up/reactions", "crews", "crews/join?token=warm-up", "crews/warm-up/stream", "crews/warm-up/members", "sync", "pause", "photos"];
