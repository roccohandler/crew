...
- **Next.** Read this commit's run: Home round 3, the Logger round 2, Progress and Plan round 2. Then the R5–R7 shots (Crew, Manage crew, Settings, Nutrition), round 1.
