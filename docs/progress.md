...
- **Then.** The verdicts on run 35447860873 (Home round 3, the Logger round 2, Progress and Plan round 2), and on the runs that follow for Crew, Settings and Nutrition round 2.
