...
S07
Home — Superseded in part by A22 G1 (a) / G4 (2026-09-18): a rest day asks nothing (no meal CTA, no premise line); the rest-day bridge's one control is the bonus workout (R-070); the third log row is "Log macros" with W8, absent until then
all five
...
S09
Session — Amended by A21.11 (tab bar hidden in-session; non-active exercises as compact rows)
...
S12
Crew screen — Superseded in part by A21.2 (no chat)
