...
Superseded in part by A22 (Appendix A, 2026-09-18): the daily habit is the WORKOUT post; meals are private macro entries (docs/nutrition-addendum.md), never posts — "snap your meals" is gone.
...
Superseded in part by A21.1 and A21.3 (Appendix A, 2026-09-17): the third question and the equipment tiers are removed — two questions, organic decisions before Home = 4 — and an invite may arrive by pasted code.
Superseded in part by A26 (Appendix A, 2026-09-18): step 3's "Brand new = 4 simple exercises at 3×10 · Experienced = 6 incl. barbell lifts" is replaced — every plan is the owner's canonical Push (5 rows), Pull (6) and Legs (5) at every experience, and experience changes the sets only (3×8 · 4×8 · 5×8); an equipment tag draws its SF Symbol on the phone.
Superseded in part by A28 (Appendix A, 2026-09-19): step 3's mobility block is listed by its holds, never "~5–10 min" (A28 (c)); step 6's organic Home is the first-day card with no reward block — no "first flame waiting" (A28 (d)).
...
Superseded in part (2026-09-18, owner-directed "launch: real UI first"): the launch frame is HOME ITSELF, drawn at once from what the phone holds — never a skeleton; a reinstalled phone's account fills in behind the real screen, piece by piece, with one line saying so.
Superseded in part by A21.3 (Appendix A, 2026-09-17): in MVP the crew token arrives by pasted invite code; universal links stay in scope, deferred to production wiring (W7).
Superseded in part by A28 (a) (Appendix A, 2026-09-19): "bone-colored" reads as the canvas token — Varsity #F7F1E4 in light, Midnight #0E1A2E in dark once the light lock lifts (R1).
...
Superseded in part by A21.1 (Appendix A, 2026-09-17): two questions (days, experience), the whisper reads "1 of 2", the equipment card and its house symbol are gone.
...
Superseded in part by A28 (a)/(e) (Appendix A, 2026-09-19): "black — it IS the ink system" no longer holds — the ink is navy; Sign in with Apple keeps the style Apple mandates (R-083 (11)); where "Your season starts today" joins the reveal is GAP 5.
Superseded in part by A21.1 (Appendix A, 2026-09-17): total decisions before Home — organic 4 (hero, days-confirm, experience, auth); invited stays 5 under the code path (GAP recorded in A21.1).
...
Superseded in part by A22 / R-070 (2026-09-18): the rest-day bridge offers "Start a bonus workout"; the meal CTA is gone.
Superseded in part by A28 (d)/(e) (Appendix A, 2026-09-19): first-day Home draws no reward block — no unlit flame, no "Your first flame lights today." — and its card's sub-line is "Your season starts today" (GAP 5); the bridge CTA is the card's ordinary capsule, not an oversized control that replaces the layout; the "+" nav button offers what exists (R-083 (22)).
...
Superseded in part by A28 (Appendix A, 2026-09-19): Home's card shows no time estimate ("~45 min", A28 (c)) and Home has no crew strip (A28 (d)); the card lists the day's exercises and starts the session, so the WORKOUT PREVIEW's job lives on the card; [Complete Workout] is "Finish workout" in the whole-workout sheet and on the mobility checklist (A28 (d)); THE MOMENT shows no minutes ("44 min", A28 (c)) and its streak numeral is ink (A28 (b)).
...
Superseded by A22 (2026-09-18): there are no meal posts — this line is history.

          → 🍽 pre-tagged → posted. 15 seconds.
Flow 3 — Tracking at the Gym, Set by Set
Superseded in part by A28 (c)/(d) (Appendix A, 2026-09-19): the diagram's session clock (⏱), its inline rest countdown ("rest 1:12"), its hold durations ("~6 min", "90s each", "timer runs it"), the base loop's "rest timer starts" and "hold-timers", and the Mobility holds and Rest timer rows are REMOVED — nothing happens between sets except the next set, and mobility is a checklist (name, cue line, check, Mark all done) that reads "3 holds", never minutes. The scrolling list of exercises becomes ONE SET PER SCREEN: the segmented workout bar (its groups jump to an exercise — "tap any exercise" stands), one card of two metric rows whose numerals are value buttons with − / + steppers (the boxed "[ 8 ] [ 135 lb ]" fields and A10's tape go), "Swap exercise" and "Skip" as text (a skip is that visible button, not a swipe), one "Log set N"; "+ set" / "+ warm-up" under ⋯; Finish in the whole-workout sheet and on the checklist, never "always visible"; a PR carries no accent and no confetti (A28 (b)).
┌──────────────────────────────────┐
...
Superseded by A22 (Appendix A, 2026-09-18): the plate journal is REMOVED — camera-first posting, time-smart tags, "Same as yesterday", text-only posts, same-day backfill and the 3-meal XP cap are gone; nutrition is macro logging only (docs/nutrition-addendum.md, ratified 2026-09-18). The permanent rejections and the seven no-grade clauses below stand; clause ⑥'s plate journal is moot.
Superseded in part by A21.5 (Appendix A, 2026-09-17): A16's model is replaced by the Stage 1 scope in docs/nutrition-addendum-draft.md (unratified); the seven no-grade clauses stand, and clause ①'s seed assertion runs over the fast-food seed.
...
Superseded by A22: moot — there is no plate journal to keep numberless; JournalFacts.line reads a legacy row by its caption.
...
Flow 5 — A Rest Day
Superseded in part by A28 (d)/(e) (Appendix A, 2026-09-19): the rest-day card reads "Rest is part of the season. Nothing to do today." and carries tomorrow; there is no filled button, and the bonus workout is reached from Home's "+".
...
Superseded by A22 G1 (a) (2026-09-18): a rest day asks nothing — no meal photo, no post; the bonus workout stays (+25, streak unchanged, V70).
Flow 6 — Crews (the accountability layer)
Superseded in part by A21.2 (Appendix A, 2026-09-17): free-text chat is removed — the stream is posts, system lines and reactions; the chat lines in the diagram and "the chat IS the comment section" no longer apply.
Amended by A28 (b) (Appendix A, 2026-09-19): the pulse, the member strip's numerals and today-dots, the crew ring and the comeback carry no accent — ink or neutral; only a flame glyph may be accent. Reactions and a crew's emoji are the members' content, not the app's glyphs (R-083 (12)).
...
Amended by A28 (e) (Appendix A, 2026-09-19): paused is OFF-SEASON — the snowflake (inkSecondary) replaces the flame under "OFF-SEASON", the card reads "Plan paused" / "Off-season until <date>. Reminders are off." with one filled "End the pause", and the ring stays accent (those workouts happened). A miss "in gray" is inkSecondary.
...
Amended by A28 (b)/(c)/(e) (Appendix A, 2026-09-19): Progress opens with "This season · N weeks · N workouts" over the heat map — ink done-days on heatEmpty, no accent anywhere on Progress (no ember ring history, no PR accent); no minutes (A28 (c)); how the layers below it live is GAP 1 and R3's.
LAYER 1 · DID I SHOW UP?    heat map (tap a day → workout + plates) ·

                            rings history · streaks · totals · meals/week
                            Superseded in part by A22 G3: the day detail lists the day's workouts (no plates); meals/week is gone.
...
Superseded in part by A22 G2 (2026-09-18): photos left every post; a workout post's optional caption (≤ 280) stays editable.
...
Superseded in part by A22 G2: camera denied → the profile picture's library path (E1); there is no post to text-first.

Superseded in part by A21.2 (Appendix A, 2026-09-17): "chat holds drafts" falls away with chat.
...
Superseded in part by A21.2 (Appendix A, 2026-09-17): reportable targets are posts, crew names and users — there are no messages.
...
Superseded in part by A22 G2: the only photo is the profile picture, visible to the crew; "photos crew-only" has no post photo to govern.
...
Superseded by A22 G1 (a) (2026-09-18): under an all-rest plan the streak counts any completed workout day (V72); nothing runs on meal posts.
...
Narrowed by A22 G2 (2026-09-18): no queued op carries a photo — after ~24 h the choice is Retry · Delete; "Post without photo" is gone.

Superseded in part by A21.2 (Appendix A, 2026-09-17): "delete own messages (tombstone)" and the chat 1,000 limit retire with chat.
...
PART III — THE COLOR SYSTEM ("Ember") AND VOICE
Superseded in part by A28 (Appendix A, 2026-09-19): the table below — both columns — and its Semantics line are replaced by the Focus Card table: Varsity light, Midnight dark, NAVY ink #142744 / #F2EEE6, accent #DE6400 / #FF8A2B, no green for done, red only inside a destructive confirm (A28 (a); design/focus-card-system.md §2; shared/design-tokens.json). The reward layer is three points — the flame glyph, the ring's arc, the celebration's XP numeral and unit — never a field (A28 (b), narrowing law ④), and the first accent a user meets is the first celebration's, not a zero-streak flame. The six laws stand, read with A28 (R-083 (3), (4)). Dark is supported (A28 (a), amending A21.10). The Voice is the system's tone — serious, optimistic, unbothered; the seasons vocabulary; no exclamation marks; no second-person imperatives outside button labels (A28 (e), R-083 (9)); "haptics only, no sound" stands.
...
PART IV — THE BUILD
Superseded in part by A21.2 (Appendix A, 2026-09-17): "chat" leaves the parity list and "chat = polling 5–10s" becomes stream polling.
...
Superseded in part by A22 (Appendix A, 2026-09-18): "nutrition posting (browser camera + file upload)" leaves the parity list.
...
Narrowed by A22 G2: Vercel Blob holds profile pictures only.
...
Superseded in part by A22 (Appendix A, 2026-09-18): the "+15 meals ×3" promise leaves the table (xpMealPost / mealXpDailyCap stay vector-bound, reachable by no client).
No shame, ever
...
Superseded by A22: food = your own numbers — never ours (no photos).
...
Superseded in part by A21.1 (plan-templates × equipment; SwapFinder equipment tiers) and A21.2 (messages routes deprecated; MessageRow retired) — Appendix A, 2026-09-17.
Amended by A28 (Appendix A, 2026-09-19): shared/design-tokens.json carries the Focus Card table, A16's macro colours, the legacy names as aliases of one row each and the type scale (R0); Session/'s RestTimerView leaves and MobilityHoldRow becomes a checklist row (A28 (c), R2); Home/ loses the week strip, the verb rows and the crew strip (A28 (d), R1); Shared/ becomes the system's component list (A28 (f)).
...
│   │   │   │                (A22, 2026-09-18: Post/ holds CameraCapture alone — the profile picture; the other three are deleted)
...
│           (A22: CameraDeniedTests → ProfilePhotoDeniedTests)
│           (A24: Tour_*Tests.swift · TourSeed.swift · TourSteps.swift — the screenshot tour; top level gains design/ and .claude/, Appendix A 2026-09-18 A24)
...
Superseded in part by A21.1 (Appendix A, 2026-09-17): generatePlan and swapCandidates lose the equip parameter — every user trains in a full gym.
...
Superseded in part by A21.1 (OnboardingModel loses equipment? and choose(equipment)) and A21.2 (CrewModel loses draft and send(); StreamItem is post | system) — Appendix A, 2026-09-17.
Amended by A28 (Appendix A, 2026-09-19): SessionModel loses restTimer / RestTimer, checkSet's "rest start", startHold's countdown→auto-check and the ghost row — holds are checked (or "Mark all done") and the set screen logs one set with "Log set N"; CelebrationOutcome's duration is never shown (A28 (c), (d)). HomeModel loses the week strip (openDay) and crewStrip, and gains the "+" destinations and the Macros fact (A28 (d)); ProgressModel gains the season label (A28 (e)); SettingsModel is lb/kg's only home (A28 (d)).
...
HomeModel         state: today: TodayState, streak, shields, weeklyRing: [DayRingState], crewStrip: [MemberDot]?
                  ...
                  (A22 G1 (a), 2026-09-18: rest carries no posted flag — a rest day asks nothing)
...
Superseded by A22 (2026-09-18): PostModel is deleted with the plate journal.
...
ProgressModel     state: heatMap: [DayCell], weeks: [RingRecord], totals, strength: [ExerciseTrend] /*only where weight logged*/
                  ...
                  (A22 G3: DayDetail lists the day's workouts; no plates)
...
Superseded in part by A21.2 (Appendix A, 2026-09-17): OpKind.sendMessage is retired.
...
Superseded in part (2026-09-18, owner-directed "launch: real UI first"): LOADING is never a full-screen skeleton — the real chrome at once, and the one thing still arriving says so in place with a small indeterminate indicator (LoadingLine); cached or local content first, network second, progressive fill.
...
Superseded in part by A21.2 (Appendix A, 2026-09-17): the VoiceOver row reads "session, posting, reacting fully completable non-visually".
Amended by A28 (a)/(b) (Appendix A, 2026-09-19): the only orange text is the celebration's XP numeral and unit — accent at large-text size, so 3:1 (WCAG 1.4.3: ≥ 24 pt, or ≥ 18.66 pt bold; R-083 (3)); every pair is gated in BOTH modes (web/tests/contrast.test.ts); the ink capsule is navy on cream (14.61:1) and cream on navy (15.05:1); a control's identifying mark clears 3:1 (R-083 (2)).
Check
Standard
Dynamic Type
...
6.6 Copy Standards
Amended by A28 (e) (Appendix A, 2026-09-19): copy speaks in seasons — in season · off-season · this season · best season · something beats nothing · a miss is a fact, not a verdict; no exclamation marks; no second-person imperatives outside button labels (ratified copy stands until its session re-cuts it with the owner — GAP 7); an eyebrow's string stays sentence case and its type role renders it uppercase (R-083 (7)).
...
Amended by A28 (d) (Appendix A, 2026-09-19): Home's one primary sits inside its optically centred card (every other screen's primary stays bottom-anchored); in the Logger the SE-at-XXL non-negotiable names "Log set N", and Finish on the whole-workout sheet and the mobility checklist; every stated control height is a minimum (R-083 (20)).
...
Amended by A28 (a) (Appendix A, 2026-09-19): the generated tokens are the Focus Card table (light the default, dark supported) and its type scale; legacy names are aliases of one row each (R-083 (1)); the web keeps parity of capability in both modes (R-083 (10)).
...
6.9 Screen Density (added 2026-09-18, A25 — pass/fail)
Screens stay simple. No screen overloaded with information; prefer clear, well-sized buttons that navigate to the screen holding the information or action. (v1 failure mode.)

In practice: a screen has one job and at most one filled (ink) primary button · secondary information lives one tap away behind a labelled control, never stacked on the screen that links to it · when a screen needs a second scroll-length of content to do its job, the content is split into a destination screen, never compressed to fit · every control meets minTouchTargetPt (6.3) — density is never bought by shrinking targets or type.
PART VII — SCREEN-BY-SCREEN ACCEPTANCE CRITERIA
...
S02
Hero (AMENDED v1.9) — Superseded in part by A21.3 (invite code)
—
...
S03
Plan questions — Superseded in part by A21.1 (two questions, "1 of 2")
—
...
S04
Generated plan — Amended by A28 (c)/(e) (2026-09-19): the mobility block reads "N holds", never a duration; "Your season starts today" (GAP 5)
loading, error
...
S07
Home — Superseded in part by A22 G1 (a) / G4 (2026-09-18): a rest day asks nothing (no meal CTA, no premise line); the rest-day bridge's one control is the bonus workout (R-070); the third log row is "Log macros" with W8, absent until then · Superseded in part by A28 (d)/(e) (2026-09-19): six states per design/targets 01–06 — the reward block (ring + flame; none on first day or with no plan; kept off-season with the snowflake) over ONE card whose title names the state, one filled primary where the state has one (none on rest and done), "Quick complete" as text, the quiet "Macros · N logged" row, cardio and bonus behind the "+" nav button; no week strip, no crew strip, no verb rows, no Resume banner (an open session makes the card's primary "Resume workout"), no nav title; the seasons strings
all five
...
S08
Workout preview — Amended by A28 (d) (2026-09-19): the Home card lists the day's exercises and targets and starts the session; the last-time values live in the Logger
loading, empty
Last-time values per exercise; Swap offers [Just today]/[Update plan]; single CTA
S09
Session — Amended by A21.11 (tab bar hidden in-session; non-active exercises as compact rows) · Superseded in part by A28 (c)/(d) (2026-09-19): one set per screen (the segmented bar, one card of two metric rows, value buttons and steppers, Swap exercise / Skip as text, "Log set N"); no ghost rows, no compact rows, no rest timer, no hold countdown (a checklist); Finish in the whole-workout sheet and on the checklist, not "always visible"
...
S10
Complete → Post — Amended by A28 (b)/(d) (2026-09-19): a full-bleed centred stack, no nav — the flame, the ink streak numeral, a phrase, the XP numeral and unit in accent (the one orange text), the summary without minutes, "Share to crew" / "Keep it private"; a PR carries no accent (GAP 9)
—
...
S11
Nutrition post — REMOVED by A22 (2026-09-18): the screen is deleted with the plate journal; the camera survives for the profile picture alone (E1)
...
S12
Crew screen — Superseded in part by A21.2 (no chat) · Amended by A28 (b) (2026-09-19): the pulse, member marks and the comeback carry no accent
...
S13
Crew create/join/invite — Superseded in part by A21.3 (code path on iOS; the Invite screen shows the code) and A27 (b) (Invite does only invite; rename, regenerate link, remove member and leave crew move to Manage crew, reached from the Crew tab, which this row's criteria now cover)
...
S14
Plan editor — Amended by A27 (a) (training days are a standing setting with no per-week override; the Change days screen states the forward-only rule in its own line)
error, undo
...
S15
Progress — Amended by A28 (b)/(c)/(e) (2026-09-19): "This season · N weeks · N workouts" over the heat map, ink done-days on heatEmpty, no accent, no minutes (GAP 1, GAP 10)
empty (new user)
Layer 3 only for weight-logged exercises; heat-map day-tap opens workout + plates; meals/week stat; empty states invite — Superseded in part by A22 G3: the day-tap opens the day's workouts; the meals/week stat is gone.
S16
History/Journal — Amended by A28 (c) (2026-09-19): no minutes on any day's line
empty
Every post forever; editing a past session never alters XP (copy says so); deleted posts absent, logs present
S17
Settings — Amended by A28 (d) (2026-09-19): lb/kg lives here only — the session never asks
—
...
Amended by A28 (Appendix A, 2026-09-19): 8.2's "duration holds" persist seed seconds as data — a hold is a checked done (A28 (c)); 8.4's journey ① ticks the mobility checklist; 8.5 and 8.9 run in BOTH appearances from the session that lifts the light lock (R1), and 8.9's S07 / S09 rows become the six Home states and the set, sheet and checklist screens (A28 (d)).
8.1 Gamification Vector Suite (shared JSON; Swift & TS engines must match EXACTLY)
RETIRED 2026-09-18 by A22 G1 (a) (Appendix A; the marker, never an edit): V01, V03, V04, V09–V15, V17, V18, V18b, V20, V21, V24, V26, V28, V29, V30, V35, V36, V43 — replaced by V66–V84 in streak-rest-days.vectors.json: V66 rest-day silence changes nothing · V67 planned day completed +1 · V68 planned miss consumes a shield · V69 planned miss resets · V70 bonus/cardio day pays XP, streak unchanged · V71 two-a-day · V72 all-rest plan counts any workout day · V73 perfect week from the plan alone · V74 shield cap · V75 imperfect by a planned rollover · V76 first partial week · V77/V78 recompute with trainingWeekdays · V79 pause · V80 date line · V81 a bonus is not insurance · V82 comeback after three missed planned days (R-069) · V83 achievements survive undo · V84 rolled-over deletion. V26 (meal XP cap) has no successor.
...
Superseded in part by A21.2 (Appendix A, 2026-09-17): the Messages row covers deprecated routes only until W3 deletes them.
...
Superseded in part by A22 (2026-09-18): POST posts is removed — a workout post is created by session completion (caption ≤ 280, no photo; PATCH posts/[id] edits it); the 3-meal cap is gone; the EXIF fixture uploads a profile picture (purpose profile only).
Crews
...
Superseded in part by A21.1 (Appendix A, 2026-09-17): the plan generator property test runs over days × experience.
...
Superseded in part by A21.2 (Appendix A, 2026-09-17): "chat draft held" is dropped.
...
Superseded in part by A22 G2: "post queued with chip" is the workout post inside its completion; the 24 h choice is Retry · Delete.
...
PART IX — DATA MODEL (final shape and invariants)
Superseded in part by A21.2 (Message retired; Reaction targets posts only) and A21.5 (nutrition documents per the addendum once ratified) — Appendix A, 2026-09-17.
Amended by A28 (c) (Appendix A, 2026-09-19): SetLog.holdSeconds is legacy data the UI no longer writes; Session.startedAt / completedAt stay data (day attribution, V07) and no screen renders an elapsed time from them.
...
A22 (2026-09-18): Post.type meal | text, photoKey, mealTag and earlierToday are LEGACY read-only fields — nothing writes them; caption ≤ 280 stays on a workout post; Photo.purpose is profile only (a legacy post photo is served to no one).
A27 (a) (2026-09-18): Plan gains trainingDaysHistory [{ from: dayKey, weekdays }] — append-only, each entry in effect from its dayKey, never edited or deleted; trainingWeekdays is always its last entry. A day is judged by the entry in effect on it (Appendix A, the line under A27).


PART X — PHASES WITH QUALITY GATES (no gate, no next phase)
Superseded in part by A21.2 (Appendix A, 2026-09-17): Phase 3's "chat (polling)" is stream polling.
Phase
Builds
Exit gate
0 Contracts
...
Ledger wording predates A21 (Appendix A, 2026-09-17): T004/T005/T020 say "equipment" (A21.1), T030/T038 say "messages"/"chat" (A21.2) — those tasks are complete as built; A21 and docs/mvp-definition.md W2–W9 govern forward work.
Ledger wording predates A28 (Appendix A, 2026-09-19): T024 (Home's Resume banner, crew-strip-absent-for-solo), T025 (SetRow + ghost row, MobilityHoldRow timers, RestTimerView) and T040 (HeatMap) describe the screens as first built — complete as built; the redesign sessions R1–R3 of docs/mvp-definition.md rebuild them under A28.
...
T027 Nutrition posting (S11): CameraCapture, library, time-smart tags, text-only, same-as-yesterday + lib/blob.ts (EXIF fixture test). Verify: posts suite + S11 criteria. — A22 (2026-09-18): complete as built, then removed with the plate journal; CameraCapture survives for the profile picture.
...
T040 Progress + Journal both platforms (S15–S16): HeatMap, layer-3 conditional rendering, plate journal. Verify: criteria pass. — A22 (2026-09-18): the plate journal is gone; the journal is workout posts.
...
Superseded in part by A21.1 ("equipment asked in onboarding") and A21.2 ("polling chat"; the unified stream carries no chat lines); "invite-link only" is amended by A21.3 (code + link) — see the 2026-09-17 A21 entry below.
Superseded in part by A26 (2026-09-18): G7 ("Some experience" = 5 exercises at 3×8–10) is replaced by the canonical templates — see the A26 entry below.
...
Superseded in part by A22 (2026-09-18): "the plate journal is photo/text only … camera + library · time-smart tags · same-day backfill · 3-meal XP cap" — the plate journal is removed; daily posts are workout posts.
Superseded in part by A28 (2026-09-19): "mobility = end-of-workout block, duration-based" → a checklist of holds, never timed (A28 (c)); "rest timer" leaves the tracking list (A28 (c)); "ghost rows" give way to one set per screen (A28 (d)); the Ember color system's palette is the Focus Card table and ember is a point (A28 (a), (b)).
...
Superseded in part by A28 (2026-09-19): G4's dark values → the Midnight column (A28 (a)); G9 is REMOVED — no rest timer, no default, no per-workout length (A28 (c)); G5's scale governs only screens not yet redesigned — a redesigned screen takes the system's spacing (A28 (d), (f); R-083 (5)); G8 stands pending GAP 2.
...
Superseded in part by A22 (2026-09-18): A3's "a way to post a meal" and its camera toolbar button are gone; the third vector row becomes "Log macros" with W8 (G4) and is absent until then.
Superseded in part by A28 (2026-09-19): A2's mobility minutes/week and A6's "· 44 min" leave (A28 (c); cardio's entered minutes: GAP 4); A3's Home enumeration gives way to the Focus Card Home — Log cardio and the bonus workout behind "+" (A28 (d)); A4's 44 pt steppers are the system's 52 pt stepper (A28 (f)); A8's "orange only on rewards" narrows to the three places (A28 (b)).

Superseded in part by A21.1 (A15 removed — Not Building) and A21.5 (A16's MODEL — "Your usual day" outlines + Flex — is replaced by the A21.5 Stage 1 scope; the seven no-grade clauses, the palette, A16.a, A16.b and A16.c stand) — see the 2026-09-17 A21 entry below.
...
Superseded in part by A22 (2026-09-18): A14's three-slot Workout · Cardio · Meals row is two slots until W8's "Log macros" (G4); the cardio post type stands.
Superseded in part by A21.5 (2026-09-17): the A16.c GAP closes — birth year is required at the moment Nutrition is opened; an account without one is asked then, never at launch.
Superseded in part by A28 (2026-09-19): A9's in-session confirmation and its permanently tappable unit label go — lb/kg lives in Settings only (A28 (d)); A10's weight tape (a ruler) goes — the value button and the steppers replace it, and its tape constants retire with R2 (A28 (d), (f)); A11's swipe and snackbar have no set rows to live on — where set removal lives on the set screen is R2's to draw (A28 (d); V54 / V55 stand); A14's seven-day strip, slot row and bottom anchor leave Home (A28 (d)); A16's macro palette stands pending GAP 6.
...
Superseded in part by A22 G3 (2026-09-18): the under-18 fallback ("the numberless plate journal exactly as today") no longer exists — an under-18 account has no nutrition surface.
...
Superseded in part by A22 G4 (2026-09-18): "a way to post a meal" is gone; the third row is "Log macros" (W8), absent while gated off.
...
Superseded in part by A28 (2026-09-19): A17.1's week sentence, crew caption and rest-day streak stake leave Home (A28 (d), (e)); A17.2's stack gives way to the centred reward block and card (A28 (d)); A17.3's slot row goes — cardio and the bonus workout behind "+" (A28 (d)); A17.4 (a)'s values → the table (accent #DE6400; emberText and emberTint retire — A28 (a), (b)), (b)'s fifth mark has no strip to mark, and (c)'s per-state nav title becomes the card's title (A28 (d)).
...
DELETED by A22 G1 (a) (2026-09-18): the premise line is gone with the daily requirement it explained — a rest day asks nothing.
...
Moot by A22 (2026-09-18): the toolbar camera and every meal CTA are gone.
...
Superseded in part by A28 (2026-09-19): A18.1's captions become eyebrows ("DAY STREAK", "OFF-SEASON") and the ring's interior eyebrow — its denominator is GAP 3; A18.2's "never while paused" goes (off-season keeps the ring — A28 (b), (d)) and its zero gate is GAP 3; A18.3's next-session block moves inside the card as TOMORROW (A28 (d)); A18.4's line becomes "Rest is part of the season. Nothing to do today." (A28 (e)); A18.5's three verb rows leave Home (A28 (d)); A18.6's paused screen is off-season — the ring stays, "Your streak is frozen" and "End the pause now" give way to the seasons strings and "End the pause" (A28 (e)); A18.7's week marks leave Home (the ring is the week) and any surviving mark is ink (A28 (b)); A18.8's bridge is the first-day card, its one CTA the card's primary, and an open session's Resume is that primary (R-083 (23)); A18.9's all-done card gains "Edit today's log" and TOMORROW (A28 (d), R-083 (18)); A18.10's toolbar holds the "+" alone; A18.11's controlOutline VALUES move to inkMuted (its 3:1 rule stands — R-083 (2)).
...
Superseded in part by A21.1 (2026-09-17): A15 is removed, so A19.6's order runs Stages C, E and F directly; A19.3 is confirmed by A21.9.
...
Superseded in part by A28 (2026-09-19): A19.1's bottom anchor stands everywhere except Home, whose primary sits in the optically centred card (A28 (d)); A19.4's Charts | Journal segment is R3's to redraw with the system's components (GAP 1); A19.5's Discard moves under the Logger's ⋯ behind its destructive confirm (R-083 (21)); the control-boundary rule above stands as "a control's identifying mark clears 3:1" — the outline-control class narrows to the stepper, whose ink glyph is its mark (A28 (f), R-083 (2)).
...
2026-09-17 — TEST ACCOUNTS FOR THE OWNER (owner-approved; the owner's instruction is the direction, this entry is the record). The owner re-runs onboarding in production with one Gmail inbox. RULING: plus-addressed variants (owner+1@gmail.com, owner+2@gmail.com, …) are DISTINCT accounts under the existing uniqueness rule — the exact lower-cased email (db.ts unique index on emailLower; auth/register looks up the same key) — and Gmail delivers them all to the base inbox, so NO code change: the server does not normalise plus-addressing or dots today and deliberately never will, and no other check moves (the per-IP auth rate limit G11, the EULA and 13+ gates, one crew per account, the deletion cascade E9/E18 all stand unchanged for everyone). In-app deletion is a hard delete that frees the address at once, so "delete account → re-onboard" is the second valid loop. TOOLING: web/scripts/purge-test-accounts.ts, LOCAL ONLY (outside src/app, refuses to run under Vercel), deletes every base+tag@domain account for the bases in TEST_EMAIL_ALLOWLIST (comma-separated, empty by default, read by that script and by nothing on the server) through the app's own deleteAccount cascade, printing what it deleted; web/scripts/alias-hooks.mjs is the resolver that lets plain node follow the app's @/ imports. LAUNCH GATE (docs/OWNER-REVIEW.md §6 step 10): TEST_EMAIL_ALLOWLIST unset in production before public launch. Full record: docs/TEST_ACCOUNT_BYPASS.md. UNTOUCHED: every gamification number, the rejected lists, the Ember laws, the budgets, the Concrete Doctrine C1–C14 and every append-only vector.

2026-09-17 — A21, THE OWNER'S RULINGS OF 2026-09-17 (owner-approved; the owner's message is the direction, this entry is the record). Thirteen rulings, each dated 2026-09-17 and owner-approved, each naming the spec sections it supersedes. Where a ruling overturns existing text, that text is NOT rewritten: the section head carries a one-line "Superseded … by A21.x" marker pointing here and the new text lives in this entry, so what was ruled before stays legible and the registry stays the one place conflicts resolve (Appendix C). Contracts: docs/mvp-definition.md (positioning, the five flows, the W1–W9 worklist) · docs/nutrition-addendum-draft.md (A21.5's proposal — NOT ratified) · docs/GYM_ASSUMPTION_MAP.md (A21.1's work order) · docs/MVP_STATE_REPORT.md (the audit these rulings answer). Three agent readings are recorded inside the rulings as GAP — conservative, open until the owner rules: the invited decision count (A21.1), the invite code being the existing token (A21.3), and whether "goal" admits a deficit (A21.5).
A21.1 EQUIPMENT (2026-09-17, owner-approved). Every user has full commercial gym access. The equipment question and the three access tiers (fullGym · dumbbells · bodyweight) are REMOVED from onboarding, both engines, the editors, the swaps and the seeds; the per-exercise equipment TAG (barbell · dumbbell · machine · cable · bodyweight) STAYS — it describes what an exercise uses inside a gym and drives the S04 chips, the swap groups and E7's no-weight rule, so no exercise entry is deleted (110 of 110 remain). Onboarding is TWO questions (days, experience); the whisper reads "1 of 2"; total decisions before Home, organic = 4 (hero, days-confirm, experience, auth). Constants move in shared/spec-constants.json only: onboardingQuestionCount 3 → 2 · decisionsBeforeHomeOrganic 5 → 4. The 30 home-tier template lists are deleted; the 15 fullGym lists remain. A15 ("change today's workout", 2026-09-09) is REMOVED from the spec — Not Building: its first escape hatch loses its meaning without tiers and A21.6 closes the door on new mechanics; V56, reserved for it, is retired unused and never assigned. GAP (agent, conservative): decisionsBeforeHomeInvited stays 5 under the A21.3 code path — the paste step takes the seat the equipment answer vacated (hero, paste, days-confirm, experience, auth) — and becomes 4 once universal links carry the token (W7). SUPERSEDES: Flow 1 step 2 ③ · 1B (the auto-advance list, "1 of 3", the house symbol) · 1C (the decision counts) · S03 · 5.2 (plan-templates × equipment; SwapFinder tiers) · 5.6.1 (the equip parameter of generatePlan and swapCandidates) · 5.6.2 (OnboardingModel equipment?, choose(equipment)) · 8.3 (the property test's equipment axis) · the wording of T004/T005/T020 · Appendix A 2026-09-04 "equipment asked in onboarding" · A15 (the 2026-09-09 entry) · Appendix B's seed lines. Work order: docs/GYM_ASSUMPTION_MAP.md, executed in W2.
A21.2 CREW SURFACE (2026-09-17, owner-approved). Free-text chat is REMOVED from both clients. The stream is posts + system lines + reactions and nothing else: the composer, the message rows, the message models and the sendMessage queue op are retired; StreamItem is post | system. Server: POST crews/[id]/messages and DELETE crews/[id]/messages/[messageId] (lib crew-messages.ts, the messages collection, messages.test.ts) are MARKED DEPRECATED; their deletion is W3's call. The S12 solo explainer's "They react 🔥💪👏😂❤️ and chat." (CrewSoloView.swift, CrewView.tsx) becomes "They react 🔥💪👏😂❤️." The polling constants keep governing the STREAM poll; chatMessageMaxChars and chatComposerMaxLines retire with the composer (W3). Reactions target posts only. Flow 6's "no comments" stands and gains no replacement — the reactions ARE the reply. SUPERSEDES: Flow 6 (the chat lines in the diagram; "the chat IS the comment section") · E6 "chat holds drafts" · E9 "message" as a report target · E20 "delete own messages (tombstone)" and "chat 1,000" · Part IV ("chat" in the parity list; "chat = polling 5–10s") · 5.2 (messages routes; MessageRow) · 5.6.2 (CrewModel draft, send(); StreamItem message) · 5.6.3 (OpKind sendMessage) · 6.5 ("chat fully completable") · S12 · 8.2 Messages row (kept only while the deprecated routes exist) · 8.6 "chat draft held" · Part IX Message and Reaction(messageId) · Part X Phase 3 "chat (polling)" · Appendix A 2026-09-04 "polling chat" and the chat half of "unified stream". Executed in W3.
A21.3 INVITES ON iOS (2026-09-17, owner-approved). An invite-CODE path is ADDED: hero [I have an invite] → paste the code → the crew preview line ("Dawn Patrol 🌅 is waiting for you", from the existing public GET crews/join) → the two questions → auth → join after auth (the existing joinCrew call) → the user lands INSIDE the crew with the "joined the crew" system line. The same entry sits on the empty Crew tab for a signed-in user (paste → preview → join, no onboarding). The Invite screen shows the code beside the share link. Explicit states per S13: dead or regenerated code, crew full, already in a crew (one crew per user). Universal links REMAIN IN SCOPE and are deferred to production wiring (W7: the AASA route, the applinks entitlement on the real host, onOpenURL feeding the same code path). The web hero's "I have an invite", which today passes an empty token, asks for the code and routes to /join/[token] (W4). GAP (agent, conservative): the code IS the crew's existing inviteToken — no new field, no new index, the same secret the link carries, regenerated by the Captain exactly as today; a shorter human-typed code is a separate owner decision, not assumed. SUPERSEDES: 1A (the token arrives by code in MVP, not only by link) · S02 · S13 · Appendix A 2026-09-04 "invite-link only" (now code + link). Executed in W4 (code) and W7 (links).
A21.4 PUSH (2026-09-17, owner-approved). iOS requests notification permission after the FIRST COMPLETED WORKOUT — the 1D moment, on the celebration's dismissal — and on grant registers for remote notifications and posts the APNs token through Api.registerPushToken via the existing OpKind.pushToken. workoutReminder DEFAULTS ON (User.notificationPrefs absent = true, A7); the reminder time is chosen at that same moment with 7:30 AM pre-filled (G12); denied → in-app banners, never re-prompted (E5). Confirms 1D, G12, A7 and T033; supersedes nothing. Executed in W4.
A21.5 NUTRITION (2026-09-17, owner-approved) — REPLACES A16's SCOPE. Stage 1: daily protein / carb / fat targets derived from body weight and goal, editable in Settings; saved meals entered manually; a daily meal template; one-tap logging from the template; quick-add grams; a Today view with remaining macros. Plus a curated fast-food seed (~10 chains × ~15 items from the chains' published nutrition facts; chain name and a neutral icon only — no logos, no food photos). Unlocks behind A16.c's 18+ gate; birth year becomes REQUIRED at the moment Nutrition is opened — an account without one is asked then, never at launch and never retroactively, which CLOSES the A16.c GAP in the direction its debt entry named. NOT BUILDING: food search, barcode, food recognition, third-party nutrition API, calorie coaching copy. Built as the FINAL block before public launch (W8, after W7). WHAT STANDS FROM A16: the seven no-grade clauses (spec:240) and their enforcement mechanisms (clause ①'s seed assertion now runs over the fast-food seed), the macro palette and its five redundant encoders, Ember law ⑥'s bounded exception, E1's single-current-bodyweight exception, A16.a (methodology screen), A16.b (age questionnaire — an owner task recorded before W8 starts), A16.c (18+), V63 as the load-bearing zero-XP vector, V57–V65 reserved. WHAT A16 LOSES: the "Your usual day" outline seed, Flex, the 50% framing flip. GAP (agent, open until ratification): A16 was ratified MAINTENANCE-ONLY and "goal" is an input here — whether it admits a deficit is the addendum's first question; until the owner answers, the draft derives maintenance and treats goal as a stored preference with no effect on the numbers. SUPERSEDES: Flow 4 (clause ①'s named seed file; the A16 model reference) · the A16 MODEL paragraph in the 2026-09-09 entry · the A16.c GAP text in the 2026-09-10 entry · Part IX (nutrition documents per the addendum once ratified). Proposal: docs/nutrition-addendum-draft.md — NOT ratified; W8's first session begins with its ratification.
Rewritten by A22 (2026-09-18): nutrition is macro logging only — the plate journal is removed; the addendum is ratified (docs/nutrition-addendum.md).
A21.6 ADAPTIVE TRAINING (2026-09-17, owner-approved). No new mechanics. Skip · swap (just today / update my plan) · bonus workout · quick complete · pause · carry-forward (A12's prefill from last performance) are the COMPLETE set. Supersedes nothing; with A21.1 it retires A15 and pre-empts any "adaptive" proposal — preparing for one is scope expansion (Appendix C).
A21.7 FIREBASE AUTH (2026-09-17, owner-approved). REJECTED. Custom auth — Sign in with Apple + email, jose JWTs, crypto.scrypt, Resend reset — is the standing decision, as built. Appendix B's ⏳ is CLOSED by marker and 12.5's standing risk is resolved; nothing is ever built against Firebase. SUPERSEDES: Appendix B's pending paragraph.
A21.8 GOOGLE SIGN-IN (2026-09-17, owner-approved). DEFERRED to v1.1. If built: ASWebAuthenticationSession on iOS, the ID token verified SERVER-SIDE against Google's JWKS (the apple-auth.ts pattern), a second accepted provider on the user document — and NO SDK, so the zero-third-party-Swift-dependency law and the npm allow-list hold. Not stubbed for (Appendix C). Supersedes nothing.
A21.9 SHARE (2026-09-17, owner-approved). A19.3 STANDS: the celebration carries two buttons — "Share to crew" (primary) and "Keep it private" (text) — and NO POST EXISTS until one is tapped: SessionActions.complete stops queueing the post with shareToCrew: true before the celebration renders; the tapped button creates the post with its actual visibility. S10's "share-default remembered" is which button is offered first (A19.3); S10's "solo skips share" is unchanged. Supersedes nothing new; records that the A19.3 defect (MVP_STATE_REPORT §12 #3) is fixed in W4.
A21.10 THEME (2026-09-17, owner-approved). AMENDED 2026-09-18 (owner-approved, the entry "LIGHT ALWAYS" below): Crew renders LIGHT on every phone regardless of its appearance setting; the dark rendering below is no longer reachable. LIGHT MODE IS THE PRIMARY; dark must render correctly on every screen. No token changes; Ember law ⑤ ("dark lifts, never inverts") and the Part III table are untouched. W6 carries a light-mode pass and a dark check on every screen (CI already photographs two dark Home states). Supersedes nothing.
Amended again by A28 (a) (2026-09-19): light is the DEFAULT and dark is SUPPORTED — the Midnight palette, reviewed exactly like light; the light lock lifts in the redesign's Home session (R1), not while any dark pair fails its gate.
A21.11 SESSION SCREEN (2026-09-17, owner-approved). The tab bar is HIDDEN during a session; non-active exercises render as COMPACT ROWS — Flow 3's ▷ rows made literal. Amends S09; executed in W6.
Superseded in part by A28 (d) (2026-09-19): the compact rows give way to one set per screen, the segmented workout bar and the whole-workout sheet; the hidden tab bar stands.
A21.12 A20 BUILD B (2026-09-17, owner-approved). PRESERVED on branch archive/a20-build-b (folder archive/a20-build-b/, commit e509314), untouched; the rebuild-or-drop decision is PENDING the owner's device walkthrough and is taken in W6. Nothing from Build B lands before that.
Overtaken by A28 (d) (2026-09-19): the Focus Card lays Home out; the branch stays preserved and untouched, and nothing from it lands without a ruling (R-083 (16)).
A21.13 NOT BUILDING (MVP) (2026-09-17, owner-approved). AMENDED 2026-09-18 (owner-approved, A27 (c) below): a dating or discovery layer joins the list. Public feed · dating · free-text chat · food search, barcode, food recognition, third-party nutrition API · leaderboards · comments · DMs · supersets · A15 · exercise media (A13, lawyer-gated — not in MVP) · web push · Android. This list joins the rejected lists CLAUDE.md rule 10 names (Flow 4, Part II, Part IV); "preparing for" any item is scope expansion.
WORKLIST: docs/mvp-definition.md orders W1–W9 (W1 is this entry on paper). The 2026-09-17 morning ruling stands: nothing is BUILT until the owner says go; W2 (gym-only) starts on that go.
UNTOUCHED BY A21: the gamification numbers and every streak/XP/shield rule, Ember laws ① ② ③ ④ ⑤ ⑥, the performance and accessibility budgets, minimumAgeYears 13, the five-tab set, the Concrete Doctrine C1–C14, and every append-only vector — 56 stay 56 until W8 appends the nutrition vectors (V57–V65); V56 is retired unused.
2026-09-17 (later) — OWNER CONFIRMATION OF THE THREE A21 GAP READINGS, AND GO FOR W2 (owner-approved; the owner's message is the direction, this entry is the record). The three readings recorded as GAP inside A21 are CONFIRMED as written and their GAP tags are CLOSED: A21.1 — decisionsBeforeHomeInvited stays 5 under the code path (hero, paste the code, days-confirm, experience, auth); A21.3 — the invite code IS the crew's existing inviteToken (no new field, no new index, the same secret the link carries), and W4 ADDS a "Copy code" button to the web landing page (/join/[token]) beside "Get the iPhone app" and "Continue on web", so a phone without the app carries the code through the App Store install; A21.5 — goal is a stored preference with NO effect on the targets until docs/nutrition-addendum-draft.md is ratified. GO FOR W2 (gym-only): contract = the W2 row of docs/mvp-definition.md, work order = every row of docs/GYM_ASSUMPTION_MAP.md, executed on both engines and both clients in the commits that follow this line. Two agent readings inside W2, recorded here: (a) exercise IDS stay stable under gym names — couch-stretch renders as "Wall Hip Flexor Stretch", doorway-pec-stretch as "Rack Pec Stretch", doorframe-row as "Suspension Trainer Row", and five cue lines lose their home objects (bench or counter, sturdy table, table edge, rolled towel, strap or towel) — so every saved plan and session keeps resolving its rows by id; (b) check-seeds gains a home-object assertion (couch, sofa, doorframe, doorway, door, table, counter, towel, chair, bed — on names and cues, never ids; objects only, so the rowing cue's "on the way home" stays) so the gym-only catalog is machine-checked rather than remembered. The templates nest kind → experience; the equipmentAccess map is deleted from the seed and its absence is asserted.
2026-09-17 (night) — OWNER: GO FOR W3 → W6 IN ONE STRETCH, ONE SMOKE TEST AT THE END (owner-approved; the owner's answer is the direction, this entry is the record). W2 is complete on master and CI-green (run 35291594989, attempt 2) but undelivered: TestFlight run 35294010935 failed at Archive on Apple's certificate cap (every archive on a fresh runner mints an Apple Development certificate; the owner revokes the runner-minted ones, then build 136 ships). Seeing the pre-W2 build 126 still ask the equipment question, the owner ruled: no device smoke test until W3 (crew surface, A21.2), W4 (invite code + web landing "Copy code" + push + two-button share + photo prompt), W5 (photos auth-checked, Apple web callback, COOKIE_SECURE, report resolution, deletion leftovers) and W6 (walkthrough fixes, A21.10, A21.11, the Build B decision input) are all on master — then ONE smoke test. W7 (owner accounts), W8 (nutrition, needs the addendum ratified) and W9 (launch) are NOT part of this go. Each W ends with the local gate set green, a commit per batch, a push and the CI verdict read; the builder does not skip a red. PAUSED THE SAME NIGHT by the owner's A22 ruling below: "W3 waits for the owner's go", and the owner wants W3 → W6 pushed together once all are done, not W by W. The W3 work already written (composer and message routes gone, blocked members out of the pulse and strip, Captain rename on both Invite panels) is parked on the local branch wip/w3-crew-surface (f8dbf22) — UNVERIFIED, no gate run, never pushed; it resumes on the go.
2026-09-17 (late) — A22, OWNER-DIRECTED — RULED AND RATIFIED 2026-09-18 (G1 (a) · G2 · G3 · G4; the entry of 2026-09-18 below is the record of each ruling) — originally PENDING THE OWNER'S RULINGS (the owner's message is the direction, this entry is the record — drafted the way A9–A16 were drafted; nothing here is built until the four GAPs below are answered and this entry is ratified; nothing here touches W2). THE RULING: nutrition is MACRO LOGGING ONLY, in the MyMacros+ shape. Meal photo/text posts — THE PLATE JOURNAL — are REMOVED from the product: no meal photo capture, no meal captions, no meal posts in the crew stream, no meal tags, no "same as yesterday", no 3-meal XP cap. A meal is a macro entry (saved meal, template slot, quick-add, fast-food seed item) and nothing else, private per A16 clause ④. Workout posts and the crew stream are unaffected except that meal cards no longer exist. SUPERSEDES ON RATIFICATION (markers, never rewrites): Flow 2's 8:30 PM dinner snap · Flow 4 entire (the seven no-grade clauses STAND for macro logging; clause ⑥ becomes moot) · Flow 5's rest-day meal photo · Flow 9's plates and meals/week · 1D's rest-day bridge CTA · E16 · E19 (narrows or goes with G2) · Part IV "nutrition posting" and "+15 meals ×3" · 5.6.2 PostModel · S07's meal CTA · S11 · S15's plates · Part IX Post type meal|text and mealTag · Appendix A 2026-09-04 "Nutrition: the plate journal is photo/text only…" · A3, A14, A17.3, A18.4, A18.5, A18.9, A18.10's meal lines · A16.c's "under-18 users get the numberless plate journal" · A21.5's scope line (which gains "the plate journal is removed"). THE MAP: docs/MEAL_POST_REMOVAL_MAP.md lists every row (spec, seed, constants, vectors, engines, routes, both clients, tests) with delete / rewrite / no-op and the GAP each depends on. THE VECTOR CONSTRAINT, ON THE RECORD: 21 append-only vectors carry a meal or text post in their fixture — V01, V03, V09, V10, V11, V12, V13, V14, V15, V17, V18, V18b, V20, V21, V24, V26, V28, V29, V35, V36, V43 — so the engine's meal/text post kinds, day.meals, xpMealPost and mealXpDailyCap STAY as a fixture-only branch no route accepts and no client reaches; the removal deletes surfaces and writable shapes, never a vector. FOUR GAPS, RECORDED VERBATIM, NOT RESOLVED:
G1 Streak on rest days. A rest day today requires a meal post or the streak breaks at 3 AM (V04). With meal posts gone: (a) rest days are exempt and the streak counts training days only (reopens A18.13); (b) a macro log counts as the day's post for the streak — streak yes, XP still zero (narrows clause ③); (c) weekly cadence. Any answer is a new registry entry plus new vectors; existing vectors are never edited.
G2 Photos on workout posts. Does the optional selfie/caption on a workout post stay, or do photos leave the app except profile pictures? If they leave: blob serves profile photos only and E19 narrows.
G3 Under-18 users. A16.c hides the macro surface under 18; with the plate journal gone they have no nutrition surface at all. Macro logging without targets, or nothing?
G4 Home's log rows. "Log a meal" becomes "Log macros" opening the nutrition Today screen — confirm, and state what the row shows when Nutrition is gated off.
SEQUENCING: the removal gets its own session after W3 (deletion before polish — W3b in docs/mvp-definition.md), and that session starts only after G1–G4 are ruled and this entry is ratified; the map names which rows wait on which GAP. CONSTRAINTS HONOURED BY THIS ENTRY: no source change, no vector edit, no constant edit. UNTOUCHED BY A22: the gamification numbers and every streak/XP/shield rule (until G1 adds its entry and vectors), Ember laws ①–⑥, the budgets, minimumAgeYears 13, the five-tab set, the Concrete Doctrine C1–C14, every append-only vector.

2026-09-17 (late, after A22) — OWNER: "GO CONTINUE WORKING ON ALL REMAINING WORK UNTIL FULL COMPLETION" (owner-approved; the owner's message is the direction, this entry is the record). Read with the owner's standing clarification of the same night — every W is pushed TOGETHER once all are done, not W by W — and with A22's "record, do not build; do not resolve the GAPs": W3, W4, W5 and W6 are built in order and pushed as one stretch; W3b (the plate-journal removal) starts only when G1–G4 are ruled; W7 (owner accounts), W8 (the addendum ratified, the A16.b rating recorded) and W9 (privacy/terms text, the store listing) are carried to the edge of what the owner's inputs allow and the remainder is named. The builder never resolves a GAP the owner reserved.

W3 EXECUTED (2026-09-17 late; the builder's calls under A21.2, recorded here; resumed from wip/w3-crew-surface and verified — every local gate green: generate/drift, 56 vectors, seeds, doctrine-lint, swift-xref, web typecheck/lint, 438 web tests, vectors, build, 32 e2e journeys, 76 native Swift tests). (1) The message routes are DELETED, not merely deprecated: nothing sends any more, and a live authenticated write path for free text would contradict "posts + system lines + reactions only" — POST crews/[id]/messages, DELETE crews/[id]/messages/[messageId], lib/crew-messages.ts, sendMessageSchema and the message report target are gone; the messages collection STAYS because system lines ("X joined the crew") live in it, a legacy `message` row is never served, and an older phone's queued sendMessage op is rejected per op as chatRetired (400, non-retryable, so its queue holds it and nothing retries forever). (2) chatMessageMaxChars and chatComposerMaxLines leave spec-constants; chatPollIntervalMin/MaxSeconds become streamPollIntervalMin/MaxSeconds (values unchanged — the stream is still polled). (3) Blocked members leave the PULSE and the MEMBER STRIP for both sides of a block (E9), on GET crews, GET crews/[id]/stream, GET crews/[id]/members and web Home — the same block set that already filtered the stream; asserted in web/tests/api/crew-stream.test.ts. (4) The Captain renames the crew or changes its emoji from both Invite panels (PATCH crews/[id] existed unused; E2, S13). (5) S12's solo copy reads "They react 🔥💪👏😂❤️." on both clients. (6) iOS: the composer, MessageRow, the draft, send() and OpKind.sendMessage are gone; web: the Composer, sendMessage and deleteMessage are gone; StreamItem is post | system on both. docs/api.md carries the route removal. No vector changed. The iOS app target compiles only on CI's macOS job (no Xcode here) — its verdict is read with the stretch's single push.
Superseded in part by A27 (b) (2026-09-18): item (4)'s place — rename and the emoji, with regenerate link, remove member and leave crew, move off both Invite panels to Manage crew, reached from the Crew tab; Invite does only invite (send the link, copy the code).
W4 EXECUTED (2026-09-17 late; the builder's calls under A21.3, A21.4, A21.9 and 1C, recorded here; every local gate green — drift, 56 vectors, seeds, doctrine-lint, swift-xref, web typecheck/lint, 443 web tests, vectors, build, 32 e2e journeys, 76 native Swift tests; the iOS app target compiles only on CI's macOS job and is read with the stretch's single push). (1) INVITE CODE (A21.3): the code IS the crew's inviteToken (the owner-confirmed GAP reading); one pure reader on both platforms — InviteCode.token(from:) ⇄ inviteToken() — accepts the bare code, the full link, or a link with a query or fragment (tests on both). iOS: hero "I have an invite" → InviteCodeScreen (paste, "Find my crew", the public preview line "Night Shift 🌙 · 1 of 10 in the crew", dead-code and crew-full states from S13) → the two questions → auth → join; the invited signup LANDS INSIDE THE CREW — the tab bar opens on Crew once (LandingFlags, set before the session exists because RootView builds the tabs the moment it does; cleared if the join fails). The empty Crew tab offers the same entry (CrewSoloView "I have an invite" → JoinByCodeSheet → CrewModel.lookUpInvite / joinByCode). The Invite screen shows the code beside the link with "Copy code". Web: the hero's "I have an invite" routes to /join (paste the code or the link → /join/[token]) or straight to /join/[token] when the URL carries one — never to /onboarding with an empty invite; the landing page shows the code and the owner's "Copy code" button (clipboard denied or absent: the code stays readable and the label says so). (2) PUSH (A21.4): the permission is asked ONCE, after the FIRST completed workout's celebration, by ReminderOptInSheet — "Get a nudge on workout days?", the time picker pre-filled at 7:30 (G12: never saved by appearing), "Remind me" (system prompt → registerForRemoteNotifications → the device token reaches POST push-token through OpKind.pushToken via PushRegistrar, the UIApplicationDelegateAdaptor → reminderTime saved by PATCH users/me) or "Not now" (nothing saved, never asked again on this phone for this account — E5); an already-authorized phone re-registers on every signed-in launch. workoutReminder stays ON by default (A7). The simulator has no APNs and fails to register silently; the UI journeys answer "Not now" — the accept path is the device smoke test's. (3) SHARE (A21.9, A19.3 stands): SessionActions.complete records the workout and creates NO post — the celebration shows a PREVIEW of what the tap will count (GamificationLocal.preview: the same computation as apply with the one post the tap inserts, nothing persisted); the two buttons "Share to crew" (primary) and "Keep it private" (text) — Done for a solo user — are the only way out (interactiveDismissDisabled); the tapped button runs SessionActions.post: the LocalPost with that visibility, the engine for real, a second patchSession carrying `post`. Server: completion creates the post ONLY when `post` is sent; a `post` on an already-completed session creates it once (sessions.ts postLateIfMissing, idempotent on the post's clientId; a second answer changes nothing) — tests/api/sessions-late-post.test.ts. A celebration the app died under (no button tapped) is remembered outside the Store (UserDefaults, no schema change) and posts PRIVATELY at the next cold start (postUnanswered) so the phone and the server agree. The remembered share default and the inert toggle are gone. (4) PHOTO PROMPT (1C): once per account, on the first Crew screen with a crew and no photo, after any invite sheet is down — "Add a photo so your crew knows it's you." → EditProfileScreen, or "Not now"; set by a join (both paths) or a create, consumed once (PhotoPromptFlag); web twin PhotoPrompt.tsx remembers the answer in the browser. Tests: iOS journey ③ (Journey3_InviteCodeTests: seeded captain → pasted code → preview → questions → save → lands on the Crew tab with the join line → the photo prompt); journeys ①/② and HomeStates updated for the two buttons and the opt-in; CelebrationPostTests, InviteCodeTests, ReminderOptInTests; web e2e journey ③ extended (hero → /join → paste the link → landing → Copy code; the joiner meets the photo prompt); invite-code.test.ts. No vector changed; no constant changed.
W5 EXECUTED (2026-09-17 late; the builder's calls, recorded here; web-only — no iOS source changed; every local gate green: drift, 56 vectors, seeds, doctrine-lint, swift-xref, web typecheck/lint, 448 web tests, vectors, build, 32 e2e journeys). (1) PHOTOS AUTH-CHECKED END TO END (8.7): blobs are written PRIVATE (`access: "private"`) and read server-side with the store token (`get`); GET photos/[key] STREAMS the bytes from either storage behind the auth check and never answers with a redirect to a blob URL — the public-blob 302 is gone; a signed-in stranger gets 403 (the key is 128 random bits, so the refusal hides nothing worth hiding and the fact is the honest answer), an unknown key 404, no session 401 — asserted in photos.test.ts. The private-blob read path runs only with a connected store (W7's Blob token); the local substitute streams the same way today. (2) APPLE WEB CALLBACK, STATE/NONCE BOUND: a new public GET auth/apple/start mints a nonce, signs it with the attempt's facts (EULA answer, where to land, timezone, birth year) into a short-lived HS256 `state` (the server's JWT secret; appleStateTtlMinutes = 10, appleNonceBytes = 16 in CryptoParams), sets the nonce as an HttpOnly SameSite=None Secure cookie scoped to /api/v1/auth/apple (Apple answers with a cross-site form POST, which a Lax cookie never accompanies) and 303s to Apple with `state` and `nonce`; the callback accepts only the matching triple — a state this server signed and not expired, the browser's cookie equal to the state's nonce, and an id_token whose `nonce` claim equals it — then signs in, clears the nonce cookie and lands on the state's `next`; EVERY failure 303s to /login?apple=failed, where the login form opens with the one Apple line the iOS screens use ("Apple couldn't sign you in. Try again, or use email below."); the old /save?apple=failed (a 404) is gone; every "Sign in with Apple" href is the start route, and the save form sends the browser's timezone with it (a GET form, read on submit — E8). Tests: the start route's shape, the happy path, and three refusals (another nonce, no cookie, an unsigned state) — auth-apple.test.ts. (3) COOKIE_SECURE DEFAULTS TO TRUE IN PRODUCTION: `Secure` follows COOKIE_SECURE when set and otherwise follows NODE_ENV=production (Vercel sets it) — cookieSecureFlag in lib/auth.ts, cookies.test.ts; .env.example says so. (4) REPORT RESOLUTION: lib/reports.ts (openReports · resolveReports — status + resolvedAt on exactly the named open reports; unknown, malformed or already-resolved ids are skipped and named) and the laptop-only scripts/resolve-reports.ts (--list, or ids; refuses to run on Vercel; prints what it resolved and what it skipped); no route ever resolves — E9's human review stays human. reports-resolve.test.ts. (5) DELETION LEFTOVERS (E9, E18): the account cascade now also removes other people's reactions on the user's posts, the reports the user filed or that name the user or their posts, the user's emailOutbox rows (by address) and pushOutbox rows (by user) — the "account deleted" email is written after the sweep and is the one row that remains; account.test.ts crawls for them and finds nothing. Found on the way and NOT fixed (recorded in debt): a web Apple signup that started from an invite lands on /crew without joining (the email path joins in the flow's finish; the Apple redirect has no hand to do it). No vector changed; no constant changed.
W6 EXECUTED (2026-09-17 late; the owner's walkthrough list, item by item, with the builder's reading of each — the owner corrects any reading that misses what the phone showed; every local gate green: drift, 56 vectors, seeds, doctrine-lint, swift-xref, web typecheck/lint, 448 web tests, vectors, build, 32 e2e journeys, 76 native Swift tests; the iOS app target compiles on CI only). (1) KEYBOARD-AWARE SAVE SCREEN (S05): the return key walks Name → Email → Password → Birth year (numberPad keeps its Done item, A19.2), and the field that takes focus is scrolled into view above the keyboard (ScrollViewReader; SwiftUI does this for a tap, not reliably for a return-key hop on a short phone); the A19.1 bottom bar stands. (2) TAPPABLE "LOG IN INSTEAD" WITH PREFILL: on the save screen (iOS) and the save form (web), one text button; the typed email travels into the login screen (OnboardingModel.prefilledEmail · /login?email=) — 1C: the login screen is a failure state reached from where the person stands, not hunted for on the hero. (3) PLAN "Mon · —" COPY: an open past day is the DAY ALONE in secondary ink — no word, no dash — on both platforms (WeekRow.swift · WeekOverview.tsx · the reveal's projection line); A8 still holds (never a verdict); the bare em dash read as a glitch on the phone and VoiceOver spoke "dash"; tests updated. (4) PROGRESS BACKGROUND TOKEN: audited rather than changed — no hard-coded colour exists anywhere under ios/Crew (grep for .white/.black/systemBackground/Color(red:…) is empty), every screen sets EmberColors.canvas, every List hides its system background, the heat map's empty cell is the hairline token (H014); nothing was found to fix, so nothing was changed, and the light/dark screenshots of item 11 are where the owner points at what the phone showed. (5) PROGRESS CTA: the empty state's button goes to TODAY (Home, where the first workout starts) instead of opening the meal composer — both platforms (MainTabs hands ProgressScreen a "go home"; web href /home); the title and line are untouched (they are A22 / W3b rows). (6) JOURNAL SEGMENT (A19.4, now executed): Progress carries a two-way segment at the top — Charts | Journal — on iOS a segmented Picker with the journal inline (the toolbar "Journal" button and the pushed screen are gone), on web a two-cell control over the two routes (ProgressSegments, aria-current; the "Journal — every post, forever" and "Back to Progress" links are gone); the five-tab bar is unchanged. (7) UNITS LABEL: iOS moves the Weight and Distance pickers out of "Plan" into their own "Units" section; web labels read "Weight unit" / "Distance unit". (8) VERSION-NUMBER RECONCILIATION: Info.plist's CFBundleShortVersionString and CFBundleVersion now READ MARKETING_VERSION and CURRENT_PROJECT_VERSION (a literal "1" made the About row say "0.1.0 (1)" on TestFlight build 126 — testflight.yml overrides CURRENT_PROJECT_VERSION with the commit count, which the row now shows); web's "Version" line reads package.json's version plus the deployed commit (VERCEL_GIT_COMMIT_SHA) instead of "beta". (9) MOBILITY NAMES GYM-ONLY: done in W2 (check-seeds HOME_WORDS over name + cue) — ticked, nothing further. (10) SESSION SCREEN PER A21.11: the tab bar is hidden during a session (.toolbar(.hidden, for: .tabBar)); every non-active exercise is ONE compact row — "▷ name · done/total · Open" (a skipped one: "· skipped · Unskip") — the full card belongs to the active exercise alone; the journeys' Skip/Complete assertions hold. (11) LIGHT-MODE PASS AND DARK CHECK (A21.10): nothing on this machine can look at a screen, so Journey4_ScreensTests photographs EVERY tab twice — light, then dark via the simulator's -AppleInterfaceStyle Dark override — Home, Plan, Crew, Progress (Charts and the Journal segment), Settings, into the xcresult for the owner's review; the code-level pass found no hard-coded colour and no screen without its canvas. (12) THE HOME DECISION ON BUILD B (A21.12): NOT TAKEN HERE — it is the owner's, after the device walkthrough; archive/a20-build-b stands untouched (recorded as an owner input in debt.md). No vector changed; no constant changed.
2026-09-18 — OWNER: LIGHT ALWAYS (owner-approved; amends A21.10; the owner's words on builds 126 and 145 — "it's showing the dark mode again when it shouldn't", three times — are the direction, this entry is the record). Crew renders LIGHT on every phone and in every browser regardless of the device's appearance setting. iOS: UIUserInterfaceStyle = Light (project.yml); the adaptive EmberColors helper stays as generated but its dark branch is never taken. Web: the generated stylesheet declares color-scheme: light and emits no prefers-color-scheme: dark block (shared/scripts/render-ember.mjs); the dark hex values stay in shared/design-tokens.json, unused — Ember law ⑤ ("dark lifts, never inverts") and the Part III table are untouched, so a future ruling can bring dark back by reverting two lines. W6's dark screenshot half (Journey4_ScreensTests.testEveryTabInDark) is retired; the light half stays. SUPERSEDES: A21.10's "dark must render correctly on every screen" (the pass that CI photographed is moot). UNTOUCHED: every token value, the light rendering everywhere.
Superseded by A28 (a) (2026-09-19): light is the default and dark is supported; the two lines that lock light (and the web's) revert in R1; until then the dark values are defined and unreachable, exactly as this entry left them.
2026-09-18 — OWNER-DIRECTED: LAUNCH: REAL UI FIRST (owner-approved; the owner's message on build 145's reinstall — "this loading skeleton is awful, it looks nothing like the actual layout" with the hierarchy optimistic UI → cached content refreshed in the background → progressive loading → small localized indicators → determinate progress, and "launch immediately and have the first usable screen ready as quickly as possible" — is the direction; this entry is the record). THE RULE: a screen draws its real chrome at once from what the phone already holds; the network fills in behind it; a piece still arriving says so IN PLACE with one line and a small indeterminate indicator; a full-screen skeleton is never shown. EXECUTED THE SAME DAY: (1) RootView shows the real tabs the moment a session exists — the HomeSkeleton branch, `pullIfEmptyBounded` and the constant hydrationMaxWaitSeconds are deleted (the reinstall "freeze" of up to 10 s is gone). (2) ServerHydrate pulls the plan, journal, sessions and account IN PARALLEL and publishes three facts (HydrationState: isPulling · failedOffline · revision); every piece that lands bumps the revision and Home re-reads the Store, so the real screen fills progressively; the crew follows. (3) Home's `.loading` is REACHABLE and means exactly "empty Store, pull running": it renders Home's own header plus one card, "Syncing your week from your account…", with the indicator — and an empty Store whose pull could not reach the server reads a retryable line ("Couldn't reach your plan yet…"), never "Build your week" (the plan exists, on the server). (4) A login on a fresh phone no longer waits for the pull — the tabs open at once and the same background pull fills Home. (5) Every ListSkeleton (Crew, Progress, the workout editor) becomes a LoadingLine with a sentence; HomeSkeleton, ListSkeleton and SkeletonBlock are deleted; skeletonPlaceholderRows leaves spec-constants. SUPERSEDES: 1A "the launch frame matches Home's skeleton"; 6.1 Loading "skeleton within 100 ms mirroring the final layout" (in part — the 100 ms stands, the skeleton does not); S01's launch frame. UNTOUCHED: S07's Store-only Home (< 500 ms warm), E6, the sync queue, every token.
2026-09-18 — A23, THE EDUCATION LAYER — OWNER-DIRECTED, PENDING RATIFICATION OF docs/education-copy-draft.md (the owner's ruling of 2026-09-18 — "record and draft, do not build" — is the direction, this entry is the record, drafted the way A22 was; nothing reaches a screen until the copy document is ratified line by line; nothing here touches W2 or W3). THE RULING: Crew gets one-time contextual WHISPERS that explain WHY the app works the way it does and HOW to use it, plus one re-readable "How Crew works" page in Settings. Never a tour, never a carousel, never a modal — 1A's "teach by doing, not touring" stands, and this EXTENDS 1C's one whisper ("Tap any exercise to swap it.") into a whisper SYSTEM. THE CONTRACT (docs/education-copy-draft.md §A): a whisper renders once, the first time its moment arrives; secondaryText ink under the element it explains; never in a modal, a sheet or on the bridge (1D); gone on the first tap anywhere, never back; ≤ 12 words; 6.6 voice; VoiceOver reads it once; seen-state persists SERVER-SIDE so iOS and web agree — PROPOSED: Part IX User gains `whispersSeen: [string]`, PATCH users/me unions into it, one @Observable WhisperState on iOS (5.6.2) and its web twin read server ∪ local, no new sync op. THE ELEVEN WHISPERS (§B, each with its trigger and screen): WHY — PPL at the plan reveal · the streak at the first lit flame on Home · crews the first time the Crew tab shows a crew · protein-first at the first nutrition target (W8, 18+) · free dinner at the first daily template (W8, 18+); HOW — progressive overload at the first row that remembers last time · swap-when-taken / skip-when-wrecked at the first session (NOT merged with the reveal's swap whisper: different moment, different lesson — the reveal keeps its 1C whisper, so the nine non-nutrition whispers are eight new plus that one) · quick complete when Home first offers it · pause the plan at the first Settings Plan group · the shake routine at the first template slot (W8, 18+) · invite by link or code at the first Invite screen. THE PAGE (§C): S19 "How Crew works" — a NEW SCREEN on both platforms, reached from a row S17 gains under About; one scrolling page, nothing interactive but links: a note from Max (draft, the owner rewrites) · sections in the owner's order (PPL with the honest frequency line and Schoenfeld 2016 linked · Protein first with 0.7–1 g/lb and Morton 2018 linked · Same foods, free dinner · Streak · Crews · Mobility · Rest days) · "What the whispers said" verbatim in trigger order · the A16.a estimate-and-clinician line. COPY CHECKS (§D): Ember law ③ · 6.6 · A8 · no guilt · under-18 users never see the three nutrition whispers (their surfaces are gated) and the page drops the protein numbers, the Morton link and the nutrition whisper lines under 18 or with no birth year, with no copy about the omission (A16.c). TOUCHES ON RATIFICATION (markers, never rewrites): 1C (one whisper → a whisper system) · S04 (a second whisper on the reveal, each under its own element, one tap clears both) · S07, S09, S12, S13, S17 (each gains a whisper moment) · S17 (gains the row) · Part VII (S19) · 5.6.2 (WhisperState) · Part IX (whispersSeen) · docs/api.md (PATCH users/me). LANDS IN: W6's second session (the page + the nine non-nutrition whispers) and W8 (the two nutrition whispers + the shake line) — docs/mvp-definition.md, both citing the ratified copy document as their source of truth. Web parity noted, not built. CONSTRAINTS HONOURED BY THIS ENTRY: no source, vector, constant or seed change. UNTOUCHED: every Ember law, the five-tab set, the gamification numbers, A16.c's gate, A22's four GAPs (the streak section deliberately says nothing about rest days until G1 is ruled).
A23 RATIFIED 2026-09-19 (owner-approved; the owner's ratification message is the direction, this line is the record — docs/ratification.md R-081): docs/education-copy-draft.md is RATIFIED with eight amendments, shared/copy/education.json is the ratified source of truth, and page.note.draft is false. (1) why.crews → "Your crew sees you show up. That's the whole system." (2) why.freeDinner → "Same breakfast and lunch every day. Dinner's yours." (3) the streak section gains, after its two sentences, "Rest days are free: the flame counts your training days, and a rest day never breaks it." — the page now agrees with A22 G1 (a), and the parenthesis above on the streak's rest-day silence is SUPERSEDED (4) the PPL section's efficiency clause → "and efficient — three sessions a week fits around a job."; the recovery sentence after it unchanged (5) the crews section: "Two to ten friends" → "Two to ten people", and its first sentence is reworded off the algorithm line to match the new whisper (the builder's wording, R-081 (2): "Being seen is the whole system.") (6) the note from Max: "nothing in here I don't do myself" → "everything in here is what I do myself"; the rest verbatim; draft: false (7) "What the whispers said" regenerated from the amended lines, still in trigger order — both apps build it from the whisper list, so it follows the file (8) ratified as written: WHY 1's wording, the no-merge decision on the swap whisper, the Settings → About placement. UNTOUCHED: the twelve ids and their triggers, every gate (the three nutrition lines stay 18+, A16.c; the page's under-18 omissions unchanged), the ≤ 12-word rule (the longest line is still HOW 6 at 11), every other line.
2026-09-18 — OWNER RULINGS: A22 RESOLVED, THE NUTRITION ADDENDUM RATIFIED, AND "CONTINUE — ALL REMAINING WORK TO FULL COMPLETION" (owner-approved; the owner's message is the direction, this entry is the record). A22 G1 (a) — REST DAYS ARE EXEMPT: the streak counts planned training days only; a rest day neither requires nor breaks it; a bonus or cardio day pays its XP and leaves the streak unchanged; for an all-rest plan any completed workout day counts; perfect week = every planned workout day completed (the "every day has a post" clause is dropped); A18.4's premise line is deleted per A18.13's own clause; the vectors that fire on meal posts are RETIRED BY MARKER (the V56 precedent), never edited, and the new rule gets new vectors from V66 (V57–V65 stay reserved for nutrition). A22 G2 — PHOTOS LEAVE THE APP EXCEPT PROFILE PICTURES; workout posts keep an optional caption ≤ 280 (captionMaxChars); blob serves profile photos only; E19 narrows to that. A22 G3 — UNDER-18 ACCOUNTS HAVE NO NUTRITION SURFACE. A22 G4 — HOME'S ROW READS "LOG MACROS" and opens the nutrition Today screen; when gated off the row is ABSENT, not disabled. NUTRITION ADDENDUM RATIFIED: Q1 maintenance only — the goal field is REMOVED, not stored; Q2 Today shows CALORIES as a fourth line beside P / C / F; Q3 the Home row is the action, Today links to Saved meals & template, targets live in Settings, no Progress segment. With these, docs/nutrition-addendum-draft.md IS RATIFIED, becomes the A21.5 contract and is renamed docs/nutrition-addendum.md. THE WORK ORDER (commit per batch, push per numbered item, the CI verdict read before the next): 1 storyboard tooling (every XCUITest step a numbered screenshot with an index in the run artifact; Playwright traces on) · 2 A22 execution (every row of docs/MEAL_POST_REMOVAL_MAP.md on both platforms, the G1 rule on both engines with new vectors, retired vectors marked, constants and seeds cleaned, Flow 5 and Home's rest state re-copied — a rest day asks nothing —, journeys rewritten, CameraDenied retired or repointed to the profile photo) · 3 W7 code half without waiting for a domain (the AASA route served from APP_BASE_URL, the applinks entitlement driven by a build variable — empty means no entitlement —, onOpenURL feeding the A21.3 code path, Copy code on the landing page; wired to the vercel.app host so a link works today) · 4 W8 nutrition in three sessions under the ratified addendum (the A16.b questionnaire is an owner task: proceed, gate only the App Store submission on it) · 5 the education layer mechanism with docs/education-copy-draft.md's copy in ONE file, the note from Max marked DRAFT; nine whispers and the page now, the two nutrition whispers and the shake line with 4 · 6 W9 (the SwiftData VersionedSchema migration; privacy and terms bodies drafted from the app's actual data practices; App Store listing copy drafted; a CI job producing store screenshots from the journeys; T047 run and its findings fixed; TEST_EMAIL_ALLOWLIST confirmed unset in production; docs/OWNER-REVIEW.md refreshed with the exact remaining owner steps). DO NOT TOUCH shared/seed/plan-templates.json beyond W2 — the canonical Push / Pull / Legs lists arrive as a separate ruling. No new features beyond the above; A21.13 governs. GAPS: continuous-build mode — a gap not covered here takes the most conservative in-spec reading, tagged // GAP:, logged in docs/ratification.md, never a reading that widens scope. OWNER TASKS, never waited on, listed in docs/OWNER-REVIEW.md: buy and attach a domain in Vercel and set APP_BASE_URL · enable Associated Domains on the App ID · the A16.b age questionnaire (nutrition + the social-media questions) · ratify docs/education-copy-draft.md and rewrite the note · review privacy/terms · provide the canonical PPL lists. THE BUILDER'S READINGS OF G1 (a) FOR THE TWO ENGINES (ratification R-068, each the most conservative in-spec reading, each open to the owner): (1) dayRolledOver keeps its shape — hadRequirement is the caller's word and now means "an uncompleted planned training day of the CURRENT plan, not paused"; plan history is not kept, so the current plan judges an unposted past day (a post's stamped isPlannedDay still stands). (2) postCreated gains an optional plannedWeekdays — the plan's ISO weekdays, [] meaning an all-rest plan: the streak counts a completed workout on a planned day, or any completed workout under an all-rest plan; the first-post-of-day XP stays for any first post of a day (V25). (3) Perfect week = every planned weekday of the week carries a completed workout when plannedWeekdays is present; a legacy fixture without the field keeps the pre-A22 clause, so no surviving vector is edited. (4) The comeback stays measured in calendar quiet days (the engine and the crew banner agree); a two-day plan can therefore fire a weekly comeback — recorded, not widened. (5) A retired vector carries a `retired` object { by, reason, replacedBy } that every runner skips and check-vectors requires to name this entry; 23 retire — the 21 meal carriers, V04 (a rest day's silence broke the streak) and V30 (a bonus day incremented it), both of which the ruling repeals — and their coverage returns from V66 with workout-only fixtures.
Superseded in part by A27 (a) (2026-09-18): reading (1)'s "plan history is not kept, so the current plan judges an unposted past day" is overturned — nothing is retroactive, so a past day keeps the judgement of the training days in force on it. Not yet built (docs/debt.md).
Superseded in part by A28 (d) (2026-09-19): G4's "Log macros" ROW becomes the quiet fact row "Macros · N logged" / "Macros · nothing logged yet" — still absent under 18 — which opens Today; the addendum's Q3 "the Home row is the action" moves the one-tap log onto Today; "a rest day asks nothing" stands and its line is "Rest is part of the season. Nothing to do today." (A28 (e)).
2026-09-18 — A24, THE VISUAL FEEDBACK LOOP (owner-approved 2026-09-18 with three amendments; builder tooling only — no product behaviour, screen, vector or constant changes; the owner's order and "A24 approved with these amendments" are the direction, this entry is the record). (1) THE TOUR IS SEEDED THROUGH THE REAL API: `CrewUITests/Tour_*Tests.swift`, one class per flow (onboarding · Home · Plan · Crew · Progress · Settings · the session at start, mid-set and complete), each seeded on the CI harness by `CrewUITests/TourSeed.swift` exactly as 8.4's journeys are (C4) — a crew with two crew-mates, six backdated workout days (the server accepts a client instant up to syncClientTimestampMaxAgeDays back), a streak. There is NO in-app fixture path and no seam in `Api` (C2/C3); the owner's "demo mode" is this seed. The two launch arguments the journeys already use (`-resetState`, `-seededReturningUser`) are now read only inside `#if DEBUG`, so no Release build can be driven by them. Macros are NOT seeded: "Log macros" is W8, behind its A16.b gate. (2) A TOUR STEP NEVER FAILS CI: a step whose element is missing is photographed as it stands and the tour moves on; the evidence is CHANGES.md ("removed"), never a red master — a red tour would block TestFlight on a tooling flake. The 8.4 journeys keep their assertions. (3) ONE WORKFLOW, ONE BUILD (amendment 5): `ci.yml` is EXTENDED, not twinned — the tour classes ride the one `xcodebuild test` the ios job already runs, so nothing compiles twice. `ci` gains `workflow_dispatch` (input `branch`), runs on a push to ANY branch, and on a non-master branch runs only `contracts` + `ios`, the latter only when `ios/scripts/ui-changed.mjs` finds a UI path in the push (ios/Crew/Features · ios/Crew/Shared · RootView/CrewApp · Generated/Ember* · ios/CrewUITests · shared/design-tokens.json · design/baselines); a newer push cancels an in-progress run on the same non-master branch. A TOUR-ONLY run (a dispatch, or a push to a non-master branch) passes `-only-testing` for the seven tour classes — the same single xcodebuild, minus the unit suite and the journeys; master, main and pull requests run everything. `testflight.yml` now requires the triggering ci run to be a PUSH, so a dispatched tour on master can never ship a build. (4) THE DIFF: `ios/scripts/tour-diff.mjs` — zero dependencies (node:zlib PNG decode; no new devDependency) — compares every tour shot with `design/baselines/` under a pixel tolerance and writes CHANGES.md (changed · expected drift · new · removed · unchanged); the simulator's status bar is pinned (`xcrun simctl status_bar override`, 9:41), and screens that render a weekday, a date, an elapsed time, a running timer or a random invite code are listed in the script and reported as EXPECTED DRIFT, never as a change — the spec defines no frozen app clock and A24 adds none. The `ui-tour` artifact (tour shots + TOUR.md + CHANGES.md, 7 days) is uploaded beside `ios-storyboard`. (5) DELIVERY AND REVIEW: `.claude/hooks/fetch-tour.mjs` (SessionStart, never blocks, 60 s) pulls the newest successful run's `ui-tour` for the current branch into the git-ignored `design/tour/latest/`; `.claude/agents/ui-reviewer.md` (read-only) judges screenshots against `design/DESIGN.md` and `design/targets/`; `/ui-check` pushes, runs or finds the ci run, watches it, fetches, and reviews only the changed screens; `/approve-screens` (owner-invoked only) copies named shots into `design/baselines/` and commits "Approve baselines: <list>". 5.2 gains `design/` (DESIGN.md · baselines/ · targets/ · tour/ ignored) and `.claude/` (settings.json · hooks/ · agents/ · skills/). (6) `design/DESIGN.md` IS A CITED DIGEST of Part III, Part VI and this registry — the spec wins every conflict — with four empty owner sections (Direction · Component kit · Banned patterns · Screen jobs); it is written AFTER the owner ratifies the density principle (drafted as A25), and 5.4 / CLAUDE.md gain the `@design/DESIGN.md` import and rule 13 ("After any change to UI code, run /ui-check before reporting the task done. A screen is not done until ui-reviewer passes it.") in that same commit. (7) NO BRANCH-DELETION EXCEPTION (amendment 6): the verification branch `scratch/ui-tour-verify` is left in place; the owner deletes it.
Amended by A28 (2026-09-19): the targets are the approved Focus Card mockups, light and dark; ui-reviewer finds each through design/targets/README.md's map and judges the matching mode; the tour gains its dark walk when the light lock lifts (R1); with no timer and no elapsed minutes left after R2, tour-diff's expected-drift list narrows to the calendar and the invite code; design/DESIGN.md's owner sections carry the system's words (A28 (f)).
2026-09-18 — A25, THE DENSITY PRINCIPLE (owner-ratified 2026-09-18; the owner's sentence is the rule, this entry is the record). "Screens stay simple. No screen overloaded with information; prefer clear, well-sized buttons that navigate to the screen holding the information or action. (v1 failure mode.)" It lands as Part VI 6.9 Screen Density, pass/fail like the rest of Part VI and so part of every screen's definition of done, with four testable clauses ratified with it: one job and at most one filled primary per screen · secondary information one tap away behind a labelled control · a second scroll-length of content becomes a destination screen · density is never bought by shrinking targets or type (6.3). It changes no screen by itself: existing screens are judged against it by ui-reviewer as they are next touched (A24 (5)). With it, A24 (6) closes: design/DESIGN.md is written, and 5.4 / CLAUDE.md gain rule 13 and the @design/DESIGN.md import.
2026-09-18 — W7 (CODE HALF), W8 (NUTRITION) AND A23 (THE EDUCATION LAYER) EXECUTED under the owner's order "CONTINUE — all remaining work to full completion" (items 3, 4 and 5; the builder's calls, recorded here and in docs/ratification.md R-074 – R-077; every local gate green — drift, 84 vectors on both engines, seeds, copy, doctrine-lint, swift-xref, launch-audit, web lint / typecheck / 521 tests / build, 53 e2e journeys at three viewports, 94 native Swift tests; the iOS app target compiles on CI only). W7: GET /.well-known/apple-app-site-association serves /join/* for <team>.<bundle> once both are configured and is ABSENT (404) until then; the applinks entitlement exists only when the repository variable CREW_APPLINKS_HOST is set; a tapped invite link takes the A21.3 pasted-code path on the hero and on the Crew tab. W8: docs/nutrition-addendum.md built in full on both platforms — four private collections behind the 18+ gate (under 18 the surface does not exist; a missing birth year is asked ONCE, where Nutrition opens), the three engine twins with V57–V65, six queued phone ops, the fast-food seed (six chains shipped from their own publications; four HELD with reasons in docs/fast-food-seed-sources.md), Today · Saved meals & template · Nutrition targets · the A16.a methodology page with four verified sources, Home's "Log macros" row (a count; absent under 18) and the Settings rows; T047's audit grep is now shared/scripts/launch-audit.mjs — the seven no-grade clauses plus A21.13, in CI (W067). 6.9 (A25) MEETS THE ADDENDUM'S TODAY: the addendum stacks the four lines, the template, quick add and the day's log on one screen, which ran past two scroll-lengths on a phone — so Today keeps its one job (the lines and one-tap template logging) and Quick add and Logged today are destinations one tap away behind labelled outline buttons; nothing the addendum gives Today is lost (R-077). CLAUSE ② as ratified says an overage "names tomorrow in the same breath": one ink sentence under the lines whenever any is over (R-075). A23: built with the DRAFT copy by the owner's order — shared/copy/education.json is the one file, the note from Max is marked Draft on the page until the owner rewrites it; User.whispersSeen is a server-side union; twelve whispers placed on both platforms (rule 3 moves how.invite out of the phone's Invite sheet, and the reveal's two whispers render at signup only — R-076); S19 "How Crew works" from Settings → About on both platforms. OWNER TASKS that remain are listed in docs/OWNER-REVIEW.md; none was waited on.
2026-09-18 — W9 (LAUNCH READINESS, THE BUILDER'S HALF) EXECUTED under the owner's order "CONTINUE — all remaining work to full completion" (item 6; the builder's calls, recorded here and in docs/ratification.md R-078). THE STORE HAS VERSIONS: ios/Crew/Storage/StoreSchema.swift declares CrewSchemaV1 (the eleven models every TestFlight build since 2026-09-10 shipped, build 150 included; its plate-journal-era LocalPost kept as a nested class so an old store is recognised), CrewSchemaV2 (today: LocalPost without photoKey · localPhotoPath · mealTag · earlierToday, plus the four nutrition models) and CrewMigrationPlan with ONE lightweight stage; Store opens under the plan, F31's start-over stays underneath for a store no version matches, the version number is the constant storage.storeSchemaVersion, and StoreMigrationTests writes a build-150 store file the way build 150 wrote it (no versioned schema) and asserts the plan, the journal and a queued op survive the update. THE LEGAL PAGES: shared/copy/legal.json → generated/copy.ts → /privacy and /terms, drafted from what the code does (what is kept, who sees it, the four providers, export and deletion, 13+ and 18+), the contact read from SUPPORT_EMAIL; the operator's legal name, a governing-law sentence and the EULA choice are the OWNER's, and the pages are a draft until the owner has reviewed them. THE LISTING: docs/app-store-listing.md (name, subtitle, promotional text, description, keywords, review notes, privacy-label answers — drafts, promising nothing on A21.13's list). STORE SCREENSHOTS: .github/workflows/store-screenshots.yml, dispatched by hand, runs the A24 tour once per App Store display class (the newest Pro Max for 6.9-inch; the newest Plus for 6.5-inch, else the newest plain iPhone with a warning) at native pixels with the status bar at 9:41, and uploads the shots with SIZES.md; it ships nothing. A24 (5) HONOURED: Tour_NutritionTests joins the tour (Home's Log macros row · Today · Quick add · Logged today · Saved meals & template · the meal form · the chain picker · the Template half · Settings' Nutrition targets and methodology · the first-run Today). T047: shared/scripts/launch-audit.mjs runs in the contracts job on every push and is clean. TEST_EMAIL_ALLOWLIST: no server code reads it (only web/scripts/purge-test-accounts.ts, by hand), so production cannot behave differently because of it; whether the NAME exists in Vercel's environment cannot be read from the build machine and is an owner check. docs/OWNER-REVIEW.md REWRITTEN: the owner's tasks in order with the exact step for each, the readings awaiting a yes, the ten-line phone checklist, the submission gates. No engine rule, vector or seed changed; one constant added (storage.storeSchemaVersion).
2026-09-18 — A26, CANONICAL TEMPLATES (owner-approved 2026-09-18; the owner's ruling is the direction, this entry is the record; it is the ruling OWNER-REVIEW §2.7 was waiting for, and it lifts the "do not touch plan-templates.json beyond W2" hold of the same day). THE RULING: every plan uses the OWNER'S OWN Push, Pull and Legs, replacing ALL existing template lists. Experience changes SETS ONLY — brand-new 3×8 · some 4×8 · experienced 5×8. No optional rows in a template; extras are added from the catalog through the plan editor's existing Add exercise. The mobility closing block stays as specced. PUSH (mid chest → triceps → upper chest → triceps → lower chest): 1 flat bench press, barbell (swap: dumbbell bench press) · 2 triceps extension, cable rope · 3 incline press, seated machine (swap: incline dumbbell press) · 4 triceps extension, cable bar · 5 decline press, machine (swaps: machine chest fly, cable fly). PULL (vertical pull → biceps → horizontal pull → biceps → rear delts → biceps): 1 lat pulldown, machine · 2 biceps curl, cable rope (swap: dumbbell curl) · 3 seated row, machine (swaps: dumbbell row, barbell row — barbell is never the default) · 4 biceps curl, cable rope (swap: dumbbell curl) · 5 face pull, cable (swap: dumbbell reverse fly) · 6 biceps curl, cable rope (swap: dumbbell curl). LEGS (floor up): 1 calf raise, machine · 2 leg press · 3 leg extension, machine · 4 hamstring curl, seated (swap: lying) · 5 lunges, dumbbell (swap: bodyweight). CATALOG: every seeded exercise is kept (110 → 131, ids stable). Six rows take the owner's words as their display name under their old ids (cable-triceps-pushdown → "Cable Bar Triceps Extension" · machine-row → "Seated Machine Row" · pec-deck → "Machine Chest Fly" · dumbbell-rear-delt-fly → "Dumbbell Reverse Fly" · lying-leg-curl → "Lying Hamstring Curl" · dumbbell-walking-lunge → "Dumbbell Lunge"), lat-pulldown's equipment tag becomes machine, and six rows are new because nothing seeded was them (cable-rope-triceps-extension · machine-incline-press · machine-decline-press · cable-rope-curl · seated-leg-curl · bodyweight-lunge). Fifteen standard machine / cable movements join as CATALOG-ONLY entries for Add exercise, per day's muscles, shoulder work on Push included (Smith incline press · low-to-high and high-to-low cable fly · cable front raise · cable upright row · overhead cable triceps extension · machine triceps extension · seated dip machine · close-grip lat pulldown · straight-arm cable pulldown · cable rear delt fly · hack squat · standing hamstring curl · cable pull-through · leg press calf raise). No home or dumbbell TIER returns (A21.1 stands). EQUIPMENT ICONS: every place an exercise row shows its equipment tag — the plan reveal, the plan editor's rows and exercise sheet, the session, the swap lists — draws an SF Symbol for the tag (barbell · dumbbell · machine · cable · bodyweight), in ink, from ONE mapping: shared/seed/exercises.json enums.equipmentSymbol → the generated files → SeedCatalog.equipmentSymbol. No asset, no dependency. The setup cue line stays. THE BUILDER'S READINGS (continuous-build mode; ratification R-079; each the most conservative in-spec reading, each open to the owner): (1) A ROW MAY REPEAT AN EXERCISE — Pull carries the cable rope curl three times, as written — so a row is addressed by its ORDER everywhere a tap names one: the reveal's swap on both platforms, "Update my plan" from a mid-workout swap (one plan row changes — the one at the session row's order, else the first holding that exercise), the web editor's move; the phone editor's swap no longer hides a candidate because it is already in the workout (the web never did). (2) NAMED SWAPS ARE KEPT BY DATA, NOT BY A NEW RULE: SwapFinder (5.6.1) is unchanged; plan-templates.json records namedSwaps, and a row with a named swap keeps swapCandidatesMin…swapCandidatesMax OTHER members in its swap group, so the finder stops at the group tier and offers them all at every experience — check-seeds and both engines' SwapFinder tests assert it. Swap groups were re-cut for that and nothing else (inclinePress · lowerChest · bodyweightRow · curlVariation are new). (3) THE `level` field no longer gates a template (the barbell bench opens a brand-new lifter's Push, as ruled); it still ranks swap candidates. (4) Full-Body A/B has not been generated since A1: its six lists and two closing blocks leave with the rest; workoutNames and split keep the two kinds for a legacy plan. (5) THE WEB CHIP STAYS WORDS: an SF Symbol is drawn by Apple's platforms and exists in no browser, and "no assets and no dependency" rules out shipping drawings of them — the same reading R-075 took for the fast-food chain icons; the mapping is generated into seed.ts for parity and is read by no web component. (6) Existing accounts keep the plan they have (Flow 8: forward-only; a plan stores its own rows) — the canonical templates reach them through Rebuild my plan. CONSTANTS (shared/spec-constants.json only): beginnerExerciseCount · someExperienceExerciseCount · experiencedExerciseCount · beginnerTargetReps · someExperienceTargetRepsMin · someExperienceTargetRepsMax LEAVE; templatePushExerciseCount 5 · templatePullExerciseCount 6 · templateLegsExerciseCount 5 · templateTargetReps 8 · experiencedTargetSets 5 ARRIVE; someExperienceTargetSets 3 → 4; beginnerTargetSets stays 3. PARKED OWNER IDEA — NOT BUILT: a dynamic warm-up block opening each workout. Recorded so it is not lost; nothing is stubbed for it (Appendix C: preparing for it is scope expansion) and it needs its own entry. SUPERSEDES (markers, never rewrites): Flow 1 step 3's counts and 3×10 · G7 · Appendix B's plan-template line · A21.1's "the 15 fullGym lists remain" · the seed's own GAP notes on experienced sets×reps and the 8–10 range · docs/OWNER-REVIEW.md §2.7 (done). UNTOUCHED: every vector (84 stay 84 — the templates are no gamification rule) · SwapFinder's and PlanGenerator's signatures · the mobility blocks for Push, Pull and Legs · every gamification number, the Ember laws, the budgets, the five-tab set, C1–C14.
Amended by A28 (c) (2026-09-19): the mobility closing block's data stays as specced (holdSeconds in the seed); it is shown as a checklist that reads "N holds", never timed; the equipment symbol and the setup cue find their place on the set screen in R2.
2026-09-18 — A27, THE SCREEN JOBS (owner-approved 2026-09-18; the owner's ratification message is the direction, this entry is the record; docs only — no source, vector, constant or seed changes with it). THE RULING: the owner's one-sentence job for every screen — 48 of them, Onboarding through Nutrition: 47 toured screens and the new Manage crew of (b), listed verbatim in design/DESIGN.md "Screen jobs" and filled into each "Screen job (one sentence):" line of design/INVENTORY.md — is RATIFIED as the test ui-reviewer applies, with one rule beneath it: "A control that does not serve its screen's job is a candidate for removal. A job with two homes has one too many." It is A25's one job per screen (6.9) named screen by screen, and like A25 it changes no screen by itself: each is judged against its job as it is next touched (A24 (5)). Three product rulings ride with it.
Amended by A28 (2026-09-19): Home's "Paused" state is off-season (A28 (e)); the whole-workout sheet and the mobility checklist take the system's jobs until the owner words them (R-083 (24)); "Weight alert" becomes the weight numeral's keypad (A28 (d)); Invite and Manage crew are built in R5 under the system's components.
A27 (a) TRAINING DAYS ARE A STANDING SETTING. A change applies from the next workout on; nothing is retroactive; there is no per-week override. The Change days screen states this in one line. (The builder's reading, open to the owner: A21.6's skip, "just today" swap, bonus workout and pause are not day overrides and stand.) Flow 8 ("Everything applies FORWARD. History never rewrites."), A4 and S14 ("forward-only stated in copy") already stated it; (a) makes it explicit for the training days, and so OVERTURNS R-068 reading (1) in the 2026-09-18 A22 entry ("plan history is not kept, so the current plan judges an unposted past day"): a past day keeps the judgement of the days in force on it. NOT YET BUILT: the server fold (gamification-recompute.ts, fed the current plan by gamification-store.ts) judges every unposted past day, past perfect weeks and the comeback count by the CURRENT weekdays, and the phone's live judge (GamificationLocal.judgeElapsedDays) judges each elapsed day by them too; GamificationRecompute.swift, the vector twin, takes one weekday set for the whole history; and the week marks, the ring history and the Journal's "Rest day" tag read the current weekdays on both clients. Honouring (a) needs the plan's weekdays kept with the day each set took effect (Part IX Plan) and new append-only vectors; no existing vector changes days mid-history (V77 and V78 hold one fixed set), so none turns red today. How a change judges the days between it and the next workout, and a week it splits, is a SPECIFICATION GAP for that build, not for this entry. The one line is not on Change days yet on iOS, which states the rule only on the week map (PlanScreen) behind the sheet; web edits the days inline on the page that already carries the line (WeekOverview), but its save status reads "your days apply from today", which contradicts it. docs/debt.md carries both halves.
A27 (b) THE INVITE SHEET'S FIVE JOBS SPLIT. Invite does only invite: send the link, copy the code (A21.3 stands). Rename, regenerate link, remove member and leave crew move to a new "Manage crew" screen reached from the Crew tab — its job: "Let me rename the crew, replace the link, remove a member, or leave." E2's powers are unchanged: rename, regenerate and remove stay Captain-only, and S13's "Captain tools visible only to Captain" now judges Manage crew; leaving is every member's, so every member reaches it. S13 and the W3 record's item (4) ("from both Invite panels") carry the marker. NOT YET BUILT: iOS InviteScreen and web CrewInvitePanel still hold all five jobs (docs/debt.md).
A27 (c) A DATING OR DISCOVERY LAYER IS NOT IN THE MVP. It joins A21.13's Not Building list (which already names dating; A21.13 carries the amendment) and with it the rejected lists CLAUDE.md rule 10 names: "preparing for" it is scope expansion.
HANDED TO THE OWNER'S CLAUDE DESIGN SESSION, not ruled here (design/INVENTORY.md §12; design/claude-design-brief/README.md): one exercise can be reordered in three places — the exercise sheet's Move up / Move down, the editor's Reorder, the nutrition template's Up / Down — and one idiom should win; Settings is ~20 rows across 2.5 screens and needs grouped destinations rather than one list; Blocked people's empty state is a gray sentence, not an invitation. A27 ADDS NO VECTOR: it is recorded, not built; (a)'s engine half appends its vectors when it is built, and no existing vector is edited. UNTOUCHED BY A27: the gamification numbers and every streak/XP/shield rule except reading (1)'s choice of which days judge a past day, every constant and seed, Ember laws ① ② ③ ④ ⑤ ⑥, the performance and accessibility budgets, minimumAgeYears 13, the five-tab set, the Concrete Doctrine C1–C14, and every append-only vector.
A27 (a) THE GAP RULED, AND THE ENGINE HALF BUILT (owner-approved 2026-09-18; the owner's ruling is the direction, this line is the record). THE RULE: a day is judged by the training days that were in effect on that day. A change to training days takes effect from the dayKey on which it is saved, forward, and never backward. A completed session is a fact and is never re-judged. Consequences, all following from the one rule and given no special case: the days between a change and the next workout are judged by the NEW days; a week split by a change has each day judged by what was in effect that day; the perfect-week test asks whether every day that was planned AT THE TIME was completed; a past day's miss, a consumed shield and an earned reward all stand. CONFIRMED, not overruled: skip, a "just today" swap, a bonus workout and pause do not change which days are planned, so none of them is a per-week override (the builder's reading above is now the owner's). BUILT 2026-09-19 (engine, server, storage; no UI): the plan keeps an append-only trainingDaysHistory — entries { from, weekdays }, each in effect from its dayKey, never edited, never deleted (Part IX; docs/api.md plans) — and a plan from before A27 is migrated to one entry in effect from its creation dayKey, written once on its first read. A change is pushed with `from` = the day it was saved: a queued phone edit's savedAt when it lies inside E15's window, else the server's now, never before the last entry. Every reader that asks "was this day planned?" now consults the entry in effect for that dayKey: the streak, comeback and perfect-week rules on both engines (postCreated carries the history, and a day the post has not reached yet is judged by the entry in effect on the post's own day, so a later change can never take back an earned reward), the server fold and the phone's elapsed-day judge, the week strip and the Plan week map (projectWeek), the weekly ring, the Progress ring history, the journal's Rest day tag, and the notification check the cron runs. The phone keeps the history as LocalTrainingDays (SwiftData CrewSchemaV3, a lightweight stage from V2; V1 and V2 untouched). Vectors V85–V90 (shared/vectors/training-days.vectors.json) are appended; no existing vector is edited, and V77/V78 run as a one-entry history. The builder's readings where the ruling was silent are R-082 (docs/ratification.md) — chiefly: a day before the first entry is judged by the first entry. The web save message now says the page's own words: "Saved · Changes apply from your next workout on." OWED, sequenced after the redesign (it restructures Crew and Plan, so building these now means building them twice): the Manage crew screen (A27 (b)), the iOS Change days sheet's rule line, and the docs/mvp-definition.md and docs/OWNER-REVIEW.md mirrors of A27 (b) and (c) — docs/debt.md carries each. OWNER-REVIEW's plan-history question is closed as answered by this ruling.

2026-09-19 — A28, THE FOCUS CARD REDESIGN (owner-approved 2026-09-19; the owner's message is the direction, this entry is the record). The owner's RATIFIED design system — design/focus-card-system.md, from Claude Design — and its APPROVED MOCKUPS — design/targets/, twelve screens drawn light and dark at 390×844 (the first-day Home supplied in dark only) — become the redesign's law through six rulings, each on its own line below and each naming what it supersedes. Where a ruling overturns existing text, that text is NOT rewritten: its head carries a one-line marker pointing here (the A21 convention). Where the system is more precise than a ruling (a size, a weight, a string), the system is the reference the ruling points to; where the system and the spec disagree on something no ruling reaches, the spec stands until the owner rules (Appendix C) and the disagreement is listed below as a SPECIFICATION GAP. THIS ENTRY'S SESSION (R0) records the rulings and moves the tokens — shared/design-tokens.json → the Generated files; no screen file changes, so the whole app RECOLORS and nothing is re-laid out. Everything a ruling asks of a SCREEN is executed in the redesign sessions docs/mvp-definition.md orders — R1 Home (six states) · R2 Logger (start, set, sheet, checklist, celebration) · R3 Progress · R4 Plan · R5 Crew + Manage crew · R6 Settings (grouped) · R7 Nutrition · then R8 warm-up blocks and R9 illustrations — each done only when ui-reviewer passes its screens against their mockups.
A28 (a) PALETTE (owner-approved 2026-09-19). LIGHT = VARSITY: canvas #F7F1E4 · card (and sheet) #FFFCF6 · ink #142744 · inkSecondary #4E5E78 · inkMuted #7E8496 · hairlineOnCard #EFE8D9 · hairlineOnCanvas #E6DCC8 · controlBorder #D3C7AE · segmentEmpty #E0D6C0 · segmentCurrent #A89C84 · chevron #A89C84 · ringTrack #E0D6C0 · heatEmpty #E4E3E1 · tabBar #FBF7EE · accent #DE6400 · onInk #FFFCF6 · destructive #BC2A1C · sheetScrim rgba(20,39,68,0.34). DARK = MIDNIGHT: canvas #0E1A2E · card #1B2A42 · ink #F2EEE6 · inkSecondary #95A6BE · inkMuted #687A93 · hairlineOnCard #26364E · hairlineOnCanvas #223049 · controlBorder #33475F · segmentEmpty #27384F · segmentCurrent #5A6E88 · chevron #5A6E88 · ringTrack #27384F · heatEmpty #27384F · tabBar #12203A · accent #FF8A2B (the light accent lifted for its ground — one hue, 27.0° / 26.9°, never re-picked) · onInk #0E1A2E · destructive #FF8575 · sheetScrim rgba(4,9,17,0.58) (design/focus-card-system.md §2, with its measured contrasts). INK IS NAVY: Part III's charcoal values (#211D19 / #F5F1EB, and "a single dark ink" wherever an older note says it) are superseded; the primary capsule inverts with the mode (navy fill + cream label in light, cream fill + navy label in dark). Nothing in the UI uses a colour that is not on this table (A16's macro colours: GAP 6 below). Light elevation is card + a two-layer shadow; dark uses tone alone (system §6). LIGHT IS THE DEFAULT; DARK IS SUPPORTED and must pass the same review — a dark screenshot is judged against the dark mockup exactly as light against light. RED ONLY INSIDE DESTRUCTIVE CONFIRMS, in both modes. SUPERSEDES: Part III's table (both columns) and its Semantics line (success #3E8E5A — no green for done; danger #D64550 → destructive, confined to a destructive confirm; "missed = warm gray" → a miss is a fact, never red) · the "bone" and "black" wording of 1A, 1C and Part III's Onboarding paragraph · G4's dark values · A17.4 (a)'s ember values (#DF5908 / #B84D00 / #FFEFE3 — its 3:1 lesson carries: accent measures 3.15:1 on the canvas) · A18.11's controlOutline values (#938C83 / #726A61; the rule stands — R-083 (2)) · 6.5's "orange text always #B84D00 on light" · 6.8's token values. AMENDS A21.10 and the 2026-09-18 entry "LIGHT ALWAYS": light stays the default and dark comes back; the light lock (Info.plist UIUserInterfaceStyle Light, the root view's .preferredColorScheme(.light), the web's color-scheme: light and its unreachable dark block) lifts in R1, the first session whose screens are drawn and reviewed in both modes, and not while any dark pair fails its gate. EXECUTED IN R0: shared/design-tokens.json `colors` IS this table (web/tests/contrast.test.ts asserts it row for row against the system document and gates every pair in both modes).
A28 (b) ORANGE IS A POINT, NOT A FIELD (owner-approved 2026-09-19). Accent is permitted in exactly three places: the FLAME GLYPH (a fill), the weekly RING'S PROGRESS ARC (a stroke), and the CELEBRATION'S XP NUMERAL AND ITS UNIT (text). The streak numeral, the ring's interior numeral, heat-map done-days and every day mark are INK; the ring's track is ringTrack, a neutral — never a tint of the accent. Accent is never a background, never on a control, never behind text, and never fills an area larger than a fingertip. The per-screen budget (system §3, assertable in a test): none on first-day Home, no-plan Home, the Logger's start, mid-set, whole-workout sheet and mobility checklist, and Progress; two (flame + ring) on training, rest and done Home; one (the ring) on off-season Home; three (flame, XP numeral, XP unit) on the celebration. The flame: accent while the streak is alive, inkMuted at zero, and off-season a snowflake in inkSecondary while the ring stays accent (those workouts happened). EMBER LAWS ①–⑥ STAND; THIS NARROWS ④ — "flame, XP, ring fills, PR/comeback/celebration" becomes the three places above, and Part III's "≤10% Ember" row with it. SUPERSEDES: Part III's reward-layer list ("streak flame, XP count-ups, ring & heat-map fills, PR / comeback / celebration accents") and "tints & ring tracks" · law ③'s "#B84D00 for orange words" (orange words retire; the XP numeral and unit are the one orange text, at large-text size — R-083 (3)) · Part III's Onboarding line "the ember flame appears for the FIRST time on Home at streak zero" (first-day Home has no reward block; the first accent is the celebration's) · A17.4 (a)'s emberTint ring track · A18.7's ember-filled day marks, wherever marks survive · the heat map's ember fills (S15, T040, W6 (4)) · every PR and comeback accent (Flow 3's PR row, Flow 6's comeback banner, Flow 9's PR moments, S10's PR badge) — a PR is stated in ink, and confetti (multi-hue) goes · A8's "orange only on rewards" (narrowed to the three places).
A28 (c) NO TIMERS ANYWHERE (owner-approved 2026-09-19). Nothing in the app counts time. The REST TIMER IS REMOVED — from the spec, the engine state, SessionModel, the constants (G9's restTimerDefaultSeconds and the GAP constant restTimerAdjustStepSeconds) and both clients: between sets nothing happens except the next set. MOBILITY HOLDS BECOME A CHECKLIST — each row a name, its cue line and a check, "Mark all done" in the header, "N of M holds done" as the count line — and holdSeconds STAYS in shared/seed/exercises.json as data, read by no screen. NO ELAPSED MINUTES OR DURATIONS ARE SHOWN ANYWHERE: no session clock, no hold duration, no time estimate on a workout, no minutes in a summary line, the journal, Progress or the celebration; a mobility row reads "4 holds", never "6 min". SUPERSEDES: Flow 1 step 3's "~5–10 min" · Flow 2's "~45 min" and "44 min" · Flow 3's session clock (⏱), "rest 1:12", "~6 min", "90s each", "timer runs it", the base loop's "rest timer starts" and "mobility block runs on hold-timers", the Mobility holds row ("Duration-based: tap a hold → countdown runs → auto-check") and the whole Rest timer row · Appendix A 2026-09-04 "mobility = end-of-workout block, duration-based" and "rest timer" in the tracking list · G9 · A2's "mobility minutes/week" · A6's "· 44 min" and minutes-counted mobility · A26's "the mobility closing block stays as specced" (its data stays; it is shown as a checklist) · 5.2's RestTimerView and MobilityHoldRow's countdown · 5.6.2's SessionModel restTimer / RestTimer, checkSet's "rest start", startHold's "countdown→auto-check", and CelebrationOutcome's duration as a displayed figure · S09's "mobility holds countdown + auto-check" · 8.2's "duration holds" and 8.4's hold countdown in journey ① · T025's "MobilityHoldRow timers, RestTimerView". Session.startedAt / completedAt stay as data (day attribution, V07) and SetLog.holdSeconds becomes legacy data the UI no longer writes; no vector changes. EXECUTED IN: R1 (the SessionSummaryLine twins stop adding "· N min" to a strength line — Home's done card reads "Push day · 6 of 6 sets"; the cardio branch follows GAP 4), R2 (the engine state, SessionModel, restTimerAdjustStepSeconds, both clients' rest timer and hold countdowns, the celebration's minutes, the tests, the tour's "the rest timer is running" step), R3 (the journal's and Progress's minutes), R4 (the plan's time estimates, and with them restTimerDefaultSeconds — its last reader is the editor's estimate — perSideHoldRepeats and planEstimateRoundingMinutes), R6 (How Crew works' mobility sentence — GAP 7). The one reading of scope: R-083 (6).
A28 (d) FOCUS CARD LAYOUTS, PER THE MOCKUPS (owner-approved 2026-09-19). HOME = the REWARD BLOCK (the weekly ring and the flame with its ink streak numeral) — absent on the first day and with no plan, where a zero would read as a verdict — over ONE CARD carrying the day (weekday eyebrow, title, one sub-line, the day's rows with their targets, "Mobility · N holds") and ONE filled primary; then "Quick complete" as a text button and a QUIET FACT ROW "Macros · N logged" / "Macros · nothing logged yet" (inkSecondary, no chevron; it opens Today; it appears on training, rest and done days as the mockups draw it, and is absent under 18, as G4 and W8 ruled (A16.c) — with no birth year on file it shows and leads to the one-time ask (A21.5)). Rest and done days carry no filled button — the card carries tomorrow, and done adds "Edit today's log" as text; off-season carries the snowflake and one filled "End the pause". CARDIO AND BONUS WORKOUTS LIVE BEHIND A "+" NAV BUTTON (an icon button with its accessibility label). THE CREW STRIP STAYS OFF HOME — and it is ON Home today on both clients: A20.6 belonged to Build B, archived under A21.12 and never landed, so this ruling itself removes it (R1), superseding Flow 2's "crew strip showing who's posted today", S07's crew-strip clauses, T024's "crew-strip-absent-for-solo" and 5.6.2's HomeModel crewStrip (the strip stays on the Crew tab). AMENDS A22 G4's row ("Log macros" → the fact row; W8's "a count; absent under 18" stands) and the addendum's Q3 ("the Home row is the action" → the fact row opens Today, where the one-tap log lives) · A18.5's three full-width verb rows (they leave Home) · with them A3's and A14's enumerations of Home (the seven-day strip, the three-slot row, the bottom anchor), A17.1's week sentence and crew caption, A17.2's stack, A17.3's slot row, A17.4 (b)'s fifth mark and (c)'s per-state nav title (the card's title names the state), A18.2's "never while paused" (off-season keeps the ring), A18.3's next-session block (tomorrow sits inside the card), A18.6 (b)'s hidden ring, A18.7's week marks on Home ("the ring is the week — no second dot row", system §11), A18.9's closed card (it gains "Edit today's log"), A18.10's toolbar (the "+" is its one glyph), S08's Workout preview and Flow 2's WORKOUT PREVIEW (the Home card does the preview's job — the day's rows with their targets and the one filled primary; the last-time values move to the Logger's set screen), A19.1's anchor for Home (its primary sits in the optically centred card; every other screen's primary stays bottom-anchored), 1D's "oversized bridge CTA" and "unlit flame", and 6.7's "primary actions stay bottom-anchored" for Home. THE LOGGER = ONE SET PER SCREEN: a header (back, the workout's name, ⋯); the SEGMENTED WORKOUT BAR, whose exercise groups are 44 pt buttons that jump to that exercise and whose count opens the whole-workout sheet; the exercise title with "Set N of M"; ONE card of two metric rows (reps, weight) whose BIG NUMERALS are value buttons opening the keypad, each with − / + STEPPERS; the last-time reference below the card on set 1 and the running ledger of logged sets after it; "Swap exercise" and "Skip" AS TEXT; one filled "Log set N". A WHOLE-WORKOUT SHEET lists each exercise with its done-of count and CARRIES FINISH; the mobility checklist is the last screen and carries Finish too; "+ set" and "+ warm-up" live UNDER ⋯; LB/KG LIVES IN SETTINGS ONLY. AMENDS A9's in-session confirmation (the session never asks; the unit is a word beside the number, and its "permanently tappable" label goes — the two fields, the device-region default, the per-set stored unit and V52/V53 stand) · A10's weight tape (a ruler — system §11 bans rulers and dials; the steppers and the value button replace it, and its tape constants retire with R2) · A21.11's compact rows (the hidden tab bar stands) · S09's ghost rows and "Complete always visible" · Flow 3's list-of-exercises screen, its "[ 8 ] [ 135 lb ]" fields and "Swipe → gray" skip · 6.7's "session Complete button visible without scrolling" (it names "Log set" and, on the sheet and the checklist, Finish). A11's removal (V54/V55) and A12's prefill stand; Discard sits under ⋯ behind its destructive confirm (R-083 (21)); where set removal lives on the set screen is R2's to draw within these rules.
A28 (e) SEASONS LANGUAGE (owner-approved 2026-09-19). Crew speaks in seasons — fixed vocabulary IN SEASON · OFF-SEASON · THIS SEASON · BEST SEASON · SOMETHING BEATS NOTHING · A MISS IS A FACT, NOT A VERDICT (system §1). Settled strings: "Your season starts today" on the reveal (GAP 5: the system and mockup 01 set it as first-day Home's card sub-line); "Off-season until <date>. Reminders are off." with the snowflake and "OFF-SEASON" when the plan is paused; "Rest is part of the season. Nothing to do today." on rest days; "This season · N weeks · N workouts" at the top of Progress — A LABEL computed from the plan's history (from the last build or rebuild, or the end of the last pause, whichever is later, to today), NO ENGINE RULE, no vector, no stored field; with them Home's "Macros · N logged", the Logger's "Quick complete" and "4 holds" (system §1's table). "Best season" is vocabulary only: no screen computes it until a ruling defines it. The paused date is written in the system's long form ("Friday 25 September"). The season label's inputs are not stored today (GAP 10). The vocabulary joins the How Crew works page's tone section (GAP 7: the page has none today). SUPERSEDES: 1D's "Your first flame lights today." · Flow 5's "Rest day — recovery is part of the plan." and A18.4's first line · A17.1's streak stake on the rest day · A18.1's "streak paused" and A18.6's "Your streak is frozen" · A18.6 (c)'s "End the pause now" (the mockup's "End the pause", one label wherever the action appears) · S15's opening (the season line over the heat map) · Part III's Voice line, amended to the system's tone — serious, optimistic, unbothered; no exclamation marks; no second-person imperatives outside button labels (R-083 (9)).
A28 (f) THE SCREEN TYPES AND THE COMPONENT LIST (owner-approved 2026-09-19). The five screen types — HOME, SET, CHECKLIST, SHEET, CELEBRATION — and the system's component list are the only ones the app may use: primary button (a filled ink capsule, onInk label 17 pt Bold, 56 pt tall on Home and 58 pt elsewhere, AT MOST ONE PER SCREEN), text button, quiet fact row, stepper, icon button, value button, check, row button, weekly ring, segmented workout bar and heat map, with the system's radii (capsule; 28 cards and a sheet's top corners; 26 stepper; 14 check; 8 heat cell; 4 / 3 segments; 3 grabber) and its type scale (§4 — every numeral SF Pro Rounded Bold, words never rounded). SUPERSEDES, as each screen's session redesigns it: every component outside the list — the outline secondary button and A18.5's verb rows, A18.11's outline-control class (it narrows to the stepper), the weight tape, boxed and underlined fields, segmented unit pickers, chips, snackbars and banners — and A24 (6)'s empty owner sections of design/DESIGN.md (Direction, Component kit and Banned patterns are the system's words since R0). GAP 1: the system names SIX types (the sixth, the data screen, is what mockup 12 draws). EXECUTED IN R0: the type scale is tokens (EmberTokens.Typography · --ember-type-*).
THE BUILDER'S READINGS (continuous-build mode; docs/ratification.md R-083 holds each in full; each the most conservative reading in the spec, each open to the owner): (1) TOKENS — `colors` is the table verbatim; every legacy name a screen still reads (inkText, secondaryText, ember, emberText, emberTint, controlOutline, missedGray, primaryButtonFill/Label, secondaryButtonLabel, hairline, danger) is an ALIAS of ONE row, so the app recolors with no screen edit, and each alias leaves when the last screen reading it is redesigned; ember → accent, emberText → ink (orange words retire; accent fails 4.5:1 for small text), emberTint → ringTrack, danger → destructive, missedGray → inkMuted (which repays the 2026-09-10 missedGray debt: 3.32:1), hairline → hairlineOnCanvas (most of its uses sit on the canvas); secondaryButtonOutline and success, which nothing read, are retired. (2) A CONTROL'S MARK STILL CLEARS 3:1 (6.5, A18.11): the stepper's controlBorder ring (~1.6:1) is never its only mark — its ink glyph is; the check's open state is a 2 pt ink ring; the bar's done segments are ink and the current exercise's are also taller; the quiet fact row's mark is its inkSecondary text (5.84:1) with the button trait; a legacy outline control keeps controlOutline → inkMuted (3.32 / 3.64 light, 3.98 / 3.29 dark) until its screen is redesigned. (3) 6.5's text gate reads with WCAG 1.4.3's large-text threshold (3:1 at ≥ 24 pt, or ≥ 18.66 pt Bold — the system states the 24 pt half, §11) — (b) needs it for the XP numeral and unit (accent 3.15:1 on the canvas): the numeral (46 pt Bold) qualifies, and the unit qualifies only when set at a large-text size — the heroUnit role (22 pt Semibold) does not, so R2 sets it at ≥ 24 pt or ≥ 18.66 pt Bold; law ③ reads with (b): those two are its one sanctioned orange text. (4) LAWS ②, ⑤, ⑥ READ WITH (a): ② keeps the canvas family warm (Varsity cream) and (a) makes the ink navy; ⑥'s "no second hue" is the system's "no third hue" — navy ink and the orange accent are the two; ⑤'s "lifts, never inverts" governs the accent (the dark accent is the light one lifted), and the capsule's mode inversion is two table rows, not an inverted ember. (5) SPACING, RADII AND COMPONENT SIZES are the system's on every redesigned screen — (d) "per the mockups" and (f) "the component list" carry them (gutter 20, card padding 22, reward block to card 30, the radii above) — so G5's "nothing off-scale" and cornerRadius 16 govern only screens not yet redesigned; each value enters design-tokens.json in the session that first draws it (C7); §12's literal snippets and §5's 59 / 34 / 49 pt are illustrations, and 6.7's safe-area-relative layout stands. (6) (c)'s "durations" are TIME SPENT TRAINING — rest, holds, the session clock, workout minutes and time estimates; a season's "N weeks" ((e) itself), a pause's return date and "max 3 weeks" are calendar facts and stay. (7) EYEBROWS: the string stays sentence case (6.6) and the type role renders it uppercase (VoiceOver reads the string); §11's "uppercase labels stacked above values" is field chrome, not an eyebrow over a fact. (8) THE LIGHT LOCK stays through R0 ("no screen file") and lifts in R1. (9) TONE: (e) adopts the system's tone with its vocabulary; new copy follows it; copy the owner already ratified (A23's whispers, 6.1's "what to do" error pattern, notifications) stands until its session re-cuts it with the owner (GAP 7). (10) WEB: 6.8 stands — parity of capability, not pixel-cloning: the web takes the same table in both modes, the same structure, flows and copy, and the type scale through system font stacks; the light lock lifts on both platforms together. (11) PLATFORM-NATIVE CONTROLS (6.8) are admitted where a job cannot be done without one — a text field, the keyboard, a date or time picker, a toggle, Sign in with Apple (whose style Apple mandates) — drawn without field chrome and in the table's colours. (12) EMOJI: user content (A21.2's five reactions, a crew's emoji, a caption) is not a glyph; §11's ban governs the app's own chrome, and the app's own emoji (🎉, 🛡, 🧊, 💪 in copy) become SF Symbols or words as their screens are redesigned. (13) 6.1's five states stand, composed from the list (a quiet line for loading and offline; an error is one sentence and the one filled "Try again"); A23's whisper is §11's "a tip appears once". (14) A season does not restart when the training days change (A27 (a) appends an entry; only a build, a rebuild or a pause's end starts one). (15) Mechanics stand under the tone: the comeback (V39), Welcome back (S18) and the reminders keep their rules and every gamification number (Appendix C); only their words move to the tone. (16) A21.12's Build B is overtaken: A28 (d) lays Home out; the branch stays preserved and untouched, and nothing from it lands without a ruling. (17) §11's "per-workout settings" are settings like the rest length (G9) and a session's unit (A9), not plan content — A4's workout editor stands. (18) "Edit today's log" (mockup 05) opens today's day in the Journal with the powers it already has (A6's delete, E3's caption) — no new edit capability. (19) The table ships through the generated adaptive colours (6.8's pipeline), not hand-made Asset Catalog colour sets: EmberColors is one Any/Dark pair per row, named as the token. (20) Every stated height (the 56 / 58 pt capsule, the 52 pt stepper, the 44 / 56 pt rows) is a MINIMUM: at accessibility sizes the label wraps and the control grows — nothing truncates (6.7, system §10). (21) Finish has two doors to one job: the mobility checklist's is the end of the workout, the whole-workout sheet's is finishing early; Discard sits under ⋯ behind its destructive confirm; the back chevron leaves with the session open (Resume). (22) The "+" offers what exists today where it exists today — Log cardio in every state with a plan, a bonus workout on rest and done days (A3, Flow 5) — and it is a route to two existing screens, not a screen with its own job. (23) An open session makes "Resume workout" the card's one filled primary in any state (A18.8's capability, one filled button). (24) The two new Logger screens take the system's jobs (§9) until the owner words them: the whole-workout sheet "jump between exercises, finish"; the mobility checklist "tick the holds, finish". (25) Table marks below 3:1 — segmentEmpty, segmentCurrent, ringTrack, heatEmpty, chevron — are never a state's only carrier (done is ink; the current segments are taller; the counts are text).
OPEN — SPECIFICATION GAPS FOR THE OWNER, each answered before the session it names (the spec stands until then): GAP 1 (before R3) — five screen types or the system's six? (f) omits the DATA SCREEN (a large title, one fact line, one card carrying the figure) that mockup 12 draws, and without it Progress, the Plan week map, the Settings list, the Crew stream, How Crew works, Nutrition's Today and the onboarding questions have no type. GAP 2 (before R2) — HAPTICS: 6.4 / G8's language (tick set done · double exercise done · thump workout complete · softTap reaction received) or system §10's (light per stepper tap and check · medium on Log set · one success on Finish · "nothing else vibrates", which drops softTap)? GAP 3 (before R1) — THE REWARD BLOCK: the mockups' ring reads "4 OF 7" where A18.1 counts completed PLANNED workouts over the week's planned count ("0/3"); a week with nothing done yet — A18.2 hides the ring below one, and no mockup draws that week; and the shields line ("1 shield ready…", A17.1) has no place on the Focus Card Home. GAP 4 (before R1) — CARDIO MINUTES: the cardio log is its entered minutes (A2); does (c)'s "no durations shown anywhere" remove them, or are they the cardio's measure? GAP 5 (before R1) — "Your season starts today": on the plan reveal (the owner's words — the reveal is onboarding, which has no redesign session), on first-day Home's card (the system's table and mockup 01), or both? GAP 6 (before the light lock lifts in R1, and R7) — A16's MACRO IDENTITY COLOURS (pine, slate, mulberry) are not on the table and the system bans a third hue; they stand unchanged for now, and dark carbs measures 2.79:1 on the Midnight card (below 3:1). GAP 7 (before R6) — COPY: How Crew works has no tone section (its sections are PPL · Protein first · Same foods · The streak · Crews · Mobility · Rest days) — a new section, or which one takes the vocabulary; its ratified Mobility sentence says "Five to ten minutes of holds"; and ratified lines with second-person imperatives ("Tap any exercise to swap it.", "Add a rep before you add weight.") meet the tone's rule. GAP 8 (before R9) — ILLUSTRATIONS: what they are; if exercise art, A21.13 lists exercise media (A13, lawyer-gated) as Not Building. GAP 9 (before R2) — THE CELEBRATION: what its phrase says ("Seven straight" in mockup 11; S10 has "Counted."), and where the badges go (PR, level-up, perfect week, comeback, achievements) now that they carry no accent and no emoji. GAP 10 (before R3) — THE SEASON LABEL'S INPUTS are not stored: nothing records a rebuild (a rebuild is an upsert like any edit; A27 (a)'s history grows only when the days change) and the phone drops a pause once it ends — may a season start be stored on the plan (written on build and rebuild), and how does the label count (a partial first week; whether bonus workouts, Quick complete and cardio logs are "workouts")?
UNTOUCHED BY A28: the gamification numbers and every streak/XP/shield rule, every append-only vector (90 stay 90), every rejected list (Flow 4, Part II, Part IV, A21.13), Ember laws ① ② ⑤ ⑥ as read with (a) (R-083 (4)), ③ save its #B84D00 clause (its one orange text is the XP numeral and unit, R-083 (3)), and ④ narrowed by (b), the performance and accessibility budgets, minimumAgeYears 13 and A16.c's 18+ gate, the five-tab set, the Concrete Doctrine C1–C14, the spacing scale and sizes tokens (until each redesign session), 6.4's haptic language (GAP 2), A16's macro colours (GAP 6), and every screen's layout until its session.
APPENDIX B — REMAINING DELIVERABLES (Phase 0 work, owner approves each)
CLOSED by A21.7 (2026-09-17, owner-approved): Firebase Auth is rejected; the custom auth below (Option A) is the standing decision. The seed lines below that say "equipment" are superseded by A21.1.
Superseded by A26 (2026-09-18, owner-approved): "Plan template contents (PPL variants × experience × equipment + Full-Body A/B)" below — the templates are the owner's three lists, one per kind.
