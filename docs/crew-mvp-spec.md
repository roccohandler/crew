...
S13
Crew create/join/invite — Superseded in part by A21.3 (code path on iOS; the Invite screen shows the code)
...
A21.13 NOT BUILDING (MVP) (2026-09-17, owner-approved). Public feed · dating · free-text chat · food search, barcode, food recognition, third-party nutrition API · leaderboards · comments · DMs · supersets · A15 · exercise media (A13, lawyer-gated — not in MVP) · web push · Android. This list joins the rejected lists CLAUDE.md rule 10 names (Flow 4, Part II, Part IV); "preparing for" any item is scope expansion.
