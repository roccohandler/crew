...
| 5 | Rest day and plan care — **PENDING A22 G1** | rest-day Home → what keeps the streak on a rest day is G1's ruling (today: a meal post; with the plate journal removed: rest days exempt, a macro log counts, or a weekly cadence) · Pause my plan (≤ 3 weeks) · plan editor: swap / tune / rebuild, forward-only | Flows 5, 7, 8, S14, S17, A22 G1 |
